...
DependencyMetadata processQueueElement(MetaDataQueueElement &&mdqe) {
  ...
  return DependencyMetadata(mdqe, intra_call_dependencies, intra_iteration_dependencies, inter_call_dependencies,
                            inter_iteration_dependencies, sink_ancestor_loops_and_functions,
                            source_ancestor_loops_and_functions);
}
