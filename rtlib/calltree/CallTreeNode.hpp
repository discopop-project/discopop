...
public:
  CallTreeNode();
  CallTreeNode(shared_ptr<CallTreeNode> parent_ptr, CallTreeNodeType type, unsigned int loop_or_function_id,
  ...
  void set(shared_ptr<CallTreeNode> arg_parent_ptr, CallTreeNodeType arg_type, unsigned int arg_loop_or_function_id,
