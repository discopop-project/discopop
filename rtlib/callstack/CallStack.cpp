...
inline bool CallStackEntry::isLoop() { return type == 1; }

inline bool CallStackEntry::isFunction() { return type == 0; }
...
void CallStack::util_compare_callstacks(CallStack *cs_1, CallStack *cs_2, std::set<LID> *intra_iteration_dependencies,
  ...
  // TODO check all combinations of call stack entrys to support multiple entry
  // points and call stacks of variable length
