...
std::string __dp::MemoryManager::allocate_memory(const LID line_id, const ADDR start_address, const ADDR end_address, const std::int64_t number_bytes, const std::int64_t number_elements) {
...
std::string __dp::MemoryManager::allocate_stack_memory(const LID line_id, const ADDR start_address, const ADDR end_address, const std::int64_t number_bytes, const std::int64_t number_elements) {
    const auto memory_region_id = get_next_free_memory_region_id();
    const auto memory_region_id_str = std::to_string(memory_region_id);
