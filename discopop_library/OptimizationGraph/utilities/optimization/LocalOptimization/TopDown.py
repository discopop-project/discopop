...
from discopop_library.OptimizationGraph.utilities.MOGUtilities import get_all_function_nodes, get_successors, \
    get_children, data_at


def get_locally_optimized_models(graph: nx.DiGraph, substitutions: Dict[Symbol, Expr]) -> Dict[FunctionRoot, List[Tuple[CostModel, ContextObject]]]:
...
#        print("DECISIONS: ", decisions_to_be_made)
#        for decision in decisions_to_be_made:
