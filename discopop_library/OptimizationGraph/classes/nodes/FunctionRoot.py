...
class FunctionRoot(Workload):
    ...
    def __init__(self, node_id: int, environment: Environment, cu_id: Optional[NodeID], name: str):
        super().__init__(node_id, environment, cu_id, sequential_workload=0, parallelizable_workload=0)
        self.name = name
        self.device_id = 0
