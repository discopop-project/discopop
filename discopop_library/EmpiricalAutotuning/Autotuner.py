...
from discopop_library.EmpiricalAutotuning.optimization.perfograph_selection import execute_perfograph_selection
...
def run(arguments: AutotunerArguments) -> None:
    ...
    if arguments.suggestions is None:
        ...
        elif perfograph_selection:
            execute_perfograph_selection(
                detection_result,
                hotspot_information,
                logger,
                time_limit_s,
