...
def generate_efficiency_report(arguments: ProjectManagerArguments) -> None:
...
def __plot_output(arguments: ProjectManagerArguments, execution_results: Dict[str, Any]) -> None:
    ...
    for configuration in execution_results:
        ...
        for script in execution_results[configuration]:
            ...
            for setting in execution_results[configuration][script]:
                ...
                tmp_values[clean_setting_str][best_thread_count][configuration] = round(speedup / best_thread_count, 3)
    ...
    plt.savefig(os.path.join(reports_dir, "efficiency.pdf"))
