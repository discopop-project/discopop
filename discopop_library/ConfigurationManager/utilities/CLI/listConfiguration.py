...
from discopop_library.ConfigurationManager.configurations.deletion import delete_configuration
...
def show_configurations_without_execution(arguments: ConfigurationManagerArguments) -> None:
...
def show_configurations_with_execution(
    arguments: ConfigurationManagerArguments, restricted_configurations: Optional[List[str]] = None
) -> None:
