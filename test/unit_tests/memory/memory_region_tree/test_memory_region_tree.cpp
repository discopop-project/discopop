...
TEST_F(MemoryRegionTreeTest2, testGetMemoryRegionId1) {
    ...
    ASSERT_EQ(tree.get_memory_region_id(0x0000000000000000LL, "fallback"), std::to_string(memory_region_id));
    ASSERT_EQ(tree.get_memory_region_id(0x7FFFFFFFFFFFFFFFLL, "fallback"), std::to_string(memory_region_id));
    ASSERT_EQ(tree.get_memory_region_id(0x5687140000000000LL, "fallback"), std::to_string(memory_region_id));
    ASSERT_EQ(tree.get_memory_region_id(0x3FF0000000000000LL, "fallback"), std::to_string(memory_region_id));
    ASSERT_EQ(tree.get_memory_region_id(0x1000000000000000LL, "fallback"), std::to_string(memory_region_id));
    ASSERT_EQ(tree.get_memory_region_id(0x5000000000000000LL, "fallback"), std::to_string(memory_region_id));
    ASSERT_EQ(tree.get_memory_region_id(0x4FFFFFFFFFFFFFFFLL, "fallback"), std::to_string(memory_region_id));
    ASSERT_EQ(tree.get_memory_region_id(0x622516846acd64b6LL, "fallback"), std::to_string(memory_region_id));
}
...
TEST_F(MemoryRegionTreeTest2, testGetMemoryRegionId2) {
    ...
    ASSERT_EQ(tree.get_memory_region_id(0x8000000000000000LL, "fallback1"), std::string("fallback1"));
    ASSERT_EQ(tree.get_memory_region_id(0xFFFFFFFFFFFFFFFFLL, "fallback2"), std::string("fallback2"));
    ASSERT_EQ(tree.get_memory_region_id(0xA687140000000000LL, "fallback3"), std::string("fallback3"));
    ASSERT_EQ(tree.get_memory_region_id(0xCFF0000000000000LL, "fallback4"), std::string("fallback4"));
    ASSERT_EQ(tree.get_memory_region_id(0x9000000000000000LL, "fallback5"), std::string("fallback5"));
    ASSERT_EQ(tree.get_memory_region_id(0xE000000000000000LL, "fallback6"), std::string("fallback6"));
    ASSERT_EQ(tree.get_memory_region_id(0xDFFFFFFFFFFFFFFFLL, "fallback7"), std::string("fallback7"));
    ASSERT_EQ(tree.get_memory_region_id(0xF22516846acd64b6LL, "fallback8"), std::string("fallback8"));
}
...
TEST_F(MemoryRegionTreeTest2, testGetMemoryRegionId3) {
    ...
    ASSERT_EQ(tree.get_memory_region_id(0x0000'0000'0000'0000LL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x1000'0000'0000'0000LL, "fallback"), std::to_string(memory_region_id));
    ASSERT_EQ(tree.get_memory_region_id(0x5687'1400'0000'0000LL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x3FF0'0000'0000'0000LL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x1242'0000'0000'0000LL, "fallback"), std::to_string(memory_region_id));
    ASSERT_EQ(tree.get_memory_region_id(0x2000'0000'0000'0000LL, "fallback"), std::to_string(memory_region_id));
    ASSERT_EQ(tree.get_memory_region_id(0x4FFF'FFFF'FFFF'FFFFLL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x8225'1684'6ac4'd4b6LL, "fallback"), std::string("fallback"));
}
...
TEST_F(MemoryRegionTreeTest2, testGetMemoryRegionId4) {
    ...
    ASSERT_EQ(tree.get_memory_region_id(0x0000'0000'0000'0000LL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x1000'0000'0000'0000LL, "fallback"), std::to_string(memory_region_id_1));
    ASSERT_EQ(tree.get_memory_region_id(0x5687'1400'0000'0000LL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x3FF0'0000'0000'0000LL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x1242'0000'0000'0000LL, "fallback"), std::to_string(memory_region_id_1));
    ASSERT_EQ(tree.get_memory_region_id(0x2000'0000'0000'0000LL, "fallback"), std::to_string(memory_region_id_2));
    ASSERT_EQ(tree.get_memory_region_id(0x4FFF'FFFF'FFFF'FFFFLL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x2225'1684'6ac4'd4b6LL, "fallback"), std::to_string(memory_region_id_2));
    ASSERT_EQ(tree.get_memory_region_id(0x2FFF'FFFF'FFFF'FFFFLL, "fallback"), std::to_string(memory_region_id_2));
    ASSERT_EQ(tree.get_memory_region_id(0x3000'0000'0000'0000LL, "fallback"), std::string("fallback"));
}
...
TEST_F(MemoryRegionTreeTest2, testGetMemoryRegionId5) {
    ...
    ASSERT_EQ(tree.get_memory_region_id(0x3FF0'0000'0000'0000LL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x1242'0000'0000'0000LL, "fallback"), std::to_string(memory_region_id_1));
    ASSERT_EQ(tree.get_memory_region_id(0x2000'0000'0000'0000LL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x4FFF'FFFF'FFFF'FFFFLL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x2225'1684'6ac4'd4b6LL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x2FFF'FFFF'FFFF'FFFFLL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x3000'0000'0000'0000LL, "fallback"), std::string("fallback"));
    ASSERT_EQ(tree.get_memory_region_id(0x5300'0000'0000'0000LL, "fallback"), std::to_string(memory_region_id_2));
    ASSERT_EQ(tree.get_memory_region_id(0x530F'FFFF'FFFF'FFFFLL, "fallback"), std::to_string(memory_region_id_2));
    ASSERT_EQ(tree.get_memory_region_id(0x53FF'FFFF'FFFF'FFFFLL, "fallback"), std::to_string(memory_region_id_2));
}
