...
@.str.8 = private unnamed_addr constant [7 x i8] c".str.3\00", align 1
...
entry:
  ...
  call void @__dp_write(i32 16398, i64 %4, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.4, i32 0, i32 0))
...
entry:
  ...
  call void @__dp_alloca(i32 16405, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0), i64 %1, i64 %1, i64 4, i64 1)
  ...
  call void @__dp_write(i32 16406, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0))
