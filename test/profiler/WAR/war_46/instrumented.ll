...
entry:
  ...
  call void @__dp_alloca(i32 16388, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i64 %0, i64 %0, i64 0, i64 1)
  %y = alloca i32, align 4
  %1 = ptrtoint i32* %y to i64
  call void @__dp_alloca(i32 16388, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0), i64 %1, i64 %1, i64 4, i64 1)
  %2 = ptrtoint i32** %b.addr to i64
  call void @__dp_write(i32 16388, i64 %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  ...
  call void @__dp_read(i32 16389, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %4 = load i32*, i32** %b.addr, align 8, !dbg !225
  %5 = ptrtoint i32* %4 to i64
  call void @__dp_read(i32 16389, i64 %5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %6 = load i32, i32* %4, align 4, !dbg !225
  %add = add nsw i32 %6, 1, !dbg !226
  %7 = ptrtoint i32* %y to i64
  call void @__dp_write(i32 16389, i64 %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  store i32 %add, i32* %y, align 4, !dbg !224
  call void @__dp_func_exit(i32 16390, i32 0), !dbg !227
  ret void, !dbg !227
}
...
entry:
  ...
  call void @__dp_alloca(i32 16392, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0), i64 %0, i64 %0, i64 0, i64 1)
  %z = alloca i32, align 4
  %1 = ptrtoint i32* %z to i64
  call void @__dp_alloca(i32 16392, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0), i64 %1, i64 %1, i64 4, i64 1)
  %2 = ptrtoint i32** %a.addr to i64
  call void @__dp_write(i32 16392, i64 %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16393, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  store i32 2, i32* %z, align 4, !dbg !232
  %4 = ptrtoint i32** %a.addr to i64
  call void @__dp_read(i32 16394, i64 %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %5 = load i32*, i32** %a.addr, align 8, !dbg !233
  call void @__dp_call(i32 16394), !dbg !234
  call void @_Z5bar_1Ri(i32* nonnull align 4 dereferenceable(4) %5), !dbg !234
  call void @__dp_func_exit(i32 16395, i32 0), !dbg !235
  ret void, !dbg !235
}

; Function Attrs: noinline nounwind optnone uwtable
define void @_Z5bar_2Pi(i32* %b) #0 !dbg !236 {
entry:
  call void @__dp_func_entry(i32 16397, i32 0)
  %b.addr = alloca i32*, align 8
  %0 = ptrtoint i32** %b.addr to i64
  call void @__dp_alloca(i32 16397, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i64 %0, i64 %0, i64 0, i64 1)
  %1 = ptrtoint i32** %b.addr to i64
  call void @__dp_write(i32 16397, i64 %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  store i32* %b, i32** %b.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %b.addr, metadata !240, metadata !DIExpression()), !dbg !241
  %2 = ptrtoint i32** %b.addr to i64
  call void @__dp_read(i32 16398, i64 %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %3 = load i32*, i32** %b.addr, align 8, !dbg !242
  %4 = ptrtoint i32* %3 to i64
  call void @__dp_write(i32 16398, i64 %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  store i32 2412, i32* %3, align 4, !dbg !243
  call void @__dp_func_exit(i32 16399, i32 0), !dbg !244
  ret void, !dbg !244
}

; Function Attrs: noinline nounwind optnone uwtable
define void @_Z5foo_2Pi(i32* %a) #0 !dbg !245 {
entry:
  call void @__dp_func_entry(i32 16401, i32 0)
  %a.addr = alloca i32*, align 8
  %0 = ptrtoint i32** %a.addr to i64
  call void @__dp_alloca(i32 16401, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0), i64 %0, i64 %0, i64 0, i64 1)
  %1 = ptrtoint i32** %a.addr to i64
  call void @__dp_write(i32 16401, i64 %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  store i32* %a, i32** %a.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %a.addr, metadata !246, metadata !DIExpression()), !dbg !247
  %2 = ptrtoint i32** %a.addr to i64
  call void @__dp_read(i32 16402, i64 %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %3 = load i32*, i32** %a.addr, align 8, !dbg !248
  call void @__dp_call(i32 16402), !dbg !249
  call void @_Z5bar_2Pi(i32* %3), !dbg !249
  call void @__dp_func_exit(i32 16403, i32 0), !dbg !250
  ret void, !dbg !250
}

; Function Attrs: noinline norecurse nounwind optnone uwtable
define i32 @main() #2 !dbg !251 {
entry:
  call void @__dp_func_entry(i32 16405, i32 1)
  %retval = alloca i32, align 4
  %0 = ptrtoint i32* %retval to i64
  call void @__dp_alloca(i32 16405, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.7, i32 0, i32 0), i64 %0, i64 %0, i64 4, i64 1)
  %x = alloca i32, align 4
  %1 = ptrtoint i32* %x to i64
  call void @__dp_alloca(i32 16405, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8, i32 0, i32 0), i64 %1, i64 %1, i64 4, i64 1)
  %2 = ptrtoint i32* %retval to i64
  call void @__dp_write(i32 16405, i64 %2, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.7, i32 0, i32 0))
  store i32 0, i32* %retval, align 4
  call void @llvm.dbg.declare(metadata i32* %x, metadata !252, metadata !DIExpression()), !dbg !253
  %3 = ptrtoint i32* %x to i64
  call void @__dp_write(i32 16406, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8, i32 0, i32 0))
  store i32 42, i32* %x, align 4, !dbg !253
  call void @__dp_call(i32 16407), !dbg !254
  call void @_Z5foo_1Ri(i32* nonnull align 4 dereferenceable(4) %x), !dbg !254
  call void @__dp_call(i32 16408), !dbg !255
  call void @_Z5foo_2Pi(i32* %x), !dbg !255
  call void @__dp_finalize(i32 16410), !dbg !256
  call void @__dp_loop_output(), !dbg !256
  ret i32 0, !dbg !256
}
...
!1 = !DIFile(filename: "test.cpp", directory: "/home/lukas/git/discopop/test/profiler/WAR/war_46")
!2 = !{}
...
!236 = distinct !DISubprogram(name: "bar_2", linkageName: "_Z5bar_2Pi", scope: !1, file: !1, line: 13, type: !237, scopeLine: 13, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!237 = !DISubroutineType(types: !238)
!238 = !{null, !239}
!239 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !10, size: 64)
!240 = !DILocalVariable(name: "b", arg: 1, scope: !236, file: !1, line: 13, type: !239)
!241 = !DILocation(line: 13, column: 17, scope: !236)
!242 = !DILocation(line: 14, column: 6, scope: !236)
!243 = !DILocation(line: 14, column: 8, scope: !236)
!244 = !DILocation(line: 15, column: 1, scope: !236)
!245 = distinct !DISubprogram(name: "foo_2", linkageName: "_Z5foo_2Pi", scope: !1, file: !1, line: 17, type: !237, scopeLine: 17, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!246 = !DILocalVariable(name: "a", arg: 1, scope: !245, file: !1, line: 17, type: !239)
!247 = !DILocation(line: 17, column: 17, scope: !245)
!248 = !DILocation(line: 18, column: 11, scope: !245)
!249 = !DILocation(line: 18, column: 5, scope: !245)
!250 = !DILocation(line: 19, column: 1, scope: !245)
!251 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 21, type: !121, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!252 = !DILocalVariable(name: "x", scope: !251, file: !1, line: 22, type: !10)
!253 = !DILocation(line: 22, column: 9, scope: !251)
!254 = !DILocation(line: 23, column: 5, scope: !251)
!255 = !DILocation(line: 24, column: 5, scope: !251)
!256 = !DILocation(line: 26, column: 5, scope: !251)
