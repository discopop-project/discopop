...
@.dp_bb_deps = private unnamed_addr constant [346 x i8] c"0=1:4 NOM INIT *|b(S136366528),1:5 NOM INIT *|y(S136366529),1:5 NOM RAW 1:4|b(S136366528)/1=1:10 NOM RAW 1:8|a(S136366531),1:8 NOM INIT *|a(S136366531),1:9 NOM INIT *|z(S136366530)/2=1:13 NOM INIT *|b(S136366532),1:14 NOM RAW 1:13|b(S136366532)/3=1:17 NOM INIT *|a(S136366533),1:18 NOM RAW 1:17|a(S136366533)/4=1:21 NOM INIT *|retval(S136366534)\00", align 1
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define void @_Z5bar_2Pi(ptr noundef %b) #0 !dbg !241 {
entry:
  ...
  store ptr %b, ptr %b.addr, align 8
    #dbg_declare(ptr %b.addr, !245, !DIExpression(), !246)
  %2 = ptrtoint ptr %b.addr to i64
  %3 = load ptr, ptr %b.addr, align 8, !dbg !247
  %4 = ptrtoint ptr %3 to i64
  call void @__dp_write(i32 16398, i64 %4, ptr @.str)
  store i32 2412, ptr %3, align 4, !dbg !248
  call void @__dp_report_bb(i32 2)
  call void @__dp_func_exit(i32 16399, i32 0), !dbg !249
  ret void, !dbg !249
}

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define void @_Z5foo_2Pi(ptr noundef %a) #0 !dbg !250 {
entry:
  ...
  store ptr %a, ptr %a.addr, align 8
    #dbg_declare(ptr %a.addr, !251, !DIExpression(), !252)
  %2 = ptrtoint ptr %a.addr to i64
  %3 = load ptr, ptr %a.addr, align 8, !dbg !253
  call void @__dp_call(i32 16402), !dbg !254
  call void @_Z5bar_2Pi(ptr noundef %3), !dbg !254
  call void @__dp_report_bb(i32 3)
  call void @__dp_func_exit(i32 16403, i32 0), !dbg !255
  ret void, !dbg !255
}

; Function Attrs: mustprogress noinline norecurse nounwind optnone uwtable
define noundef i32 @main() #1 !dbg !256 {
entry:
  ...
  call void @__dp_call(i32 16407), !dbg !259
  call void @_Z5foo_1Ri(ptr noundef nonnull align 4 dereferenceable(4) %x), !dbg !259
  call void @__dp_call(i32 16408), !dbg !260
  call void @_Z5foo_2Pi(ptr noundef %x), !dbg !260
  call void @__dp_report_bb(i32 4)
  call void @__dp_add_bb_deps(ptr @.dp_bb_deps)
  call void @__dp_finalize(i32 16410), !dbg !261
  call void @__dp_loop_output(), !dbg !261
  ret i32 0, !dbg !261
}
...
!1 = !DIFile(filename: "test.cpp", directory: "/home/lukas/git/discopop/test/profiler/WAR/war_46", checksumkind: CSK_MD5, checksum: "8982e0197bf49239230dd4ac17fb040a")
...
!241 = distinct !DISubprogram(name: "bar_2", linkageName: "_Z5bar_2Pi", scope: !1, file: !1, line: 13, type: !242, scopeLine: 13, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !224)
!242 = !DISubroutineType(types: !243)
!243 = !{null, !244}
!244 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !9, size: 64)
!245 = !DILocalVariable(name: "b", arg: 1, scope: !241, file: !1, line: 13, type: !244)
!246 = !DILocation(line: 13, column: 17, scope: !241)
!247 = !DILocation(line: 14, column: 6, scope: !241)
!248 = !DILocation(line: 14, column: 8, scope: !241)
!249 = !DILocation(line: 15, column: 1, scope: !241)
!250 = distinct !DISubprogram(name: "foo_2", linkageName: "_Z5foo_2Pi", scope: !1, file: !1, line: 17, type: !242, scopeLine: 17, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !224)
!251 = !DILocalVariable(name: "a", arg: 1, scope: !250, file: !1, line: 17, type: !244)
!252 = !DILocation(line: 17, column: 17, scope: !250)
!253 = !DILocation(line: 18, column: 11, scope: !250)
!254 = !DILocation(line: 18, column: 5, scope: !250)
!255 = !DILocation(line: 19, column: 1, scope: !250)
!256 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 21, type: !122, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !224)
!257 = !DILocalVariable(name: "x", scope: !256, file: !1, line: 22, type: !9)
!258 = !DILocation(line: 22, column: 9, scope: !256)
!259 = !DILocation(line: 23, column: 5, scope: !256)
!260 = !DILocation(line: 24, column: 5, scope: !256)
!261 = !DILocation(line: 26, column: 5, scope: !256)
