...
public:
  ...
  double &x(int idx) { return arr_x[idx]; }

  double &y(int idx) { return arr_y[idx]; }

  double &z(int idx) { return arr_z[idx]; }

  double &fx(int idx) { return arr_fx[idx]; }

  double &fy(int idx) { return arr_fy[idx]; }
