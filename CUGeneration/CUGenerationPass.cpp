...
//     Variable_struct(const Variable_struct &other) : name(other.name),
//     type(other.type), defLine(other.defLine)
//     {
//     }

//     Variable_struct(string n, string t, string d) : name(n), type(t),
//     defLine(d)
//     {
//     }

//     // We have a set of this struct. The set doesn't know how to order the
//     elements. inline bool operator<(const Variable_struct &rhs) const
//     {
...
//     unsigned writeDataSize; // number of bytes written into memory during the
//     cu unsigned instructionsCount;
...
//   string
//   determineVariableName(Instruction *I,
