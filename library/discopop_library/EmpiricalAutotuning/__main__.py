...
def parse_args() -> AutotunerArguments:
    ...
    parser.add_argument("-A", "--algorithm", type=int, default=0, help="Optimization algorithm. Values: 0: no combination of suggestions. 1: linear combination, 2: linear combination with refinement. 3: evolutionary combination. 4: greedy forward search (O(N) evaluations). 5: coordinate descent / bit-flip local search. Default: 0.")
