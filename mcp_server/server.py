            ...
            tools = [
                ...
                Tool(
                    ...
                    description=(
                        ...
                        "program. If the program accepts input data or a parameter controlling problem "
                        "size, always prefer the smallest input that still exercises the code paths of "
                        "interest. Configurations with unnecessarily large workloads may become "
                        "impractically slow under instrumentation. "
                        "\n\n"
                ...
                Tool(
                    ...
                    description=(
                        ...
                        "will run noticeably slower than the original. Long execution times must be "
                        "expected. To keep profiling practical, use the smallest input or problem size "
                        "that still exercises the loops of interest. If no suitable small input exists, "
