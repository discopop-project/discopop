            ...
            tools = [
                ...
                Tool(
                    ...
                    description=(
                        ...
                        "argument sets). DiscoPoP collects runtime profiling data from each run, so "
                        "configurations with representative workloads lead to better pattern detection. "
                        "\n\n"
                        ...
                        "  Minimal:              ./myapp\n"
                        "  With arguments:       ./myapp --input data/small.txt --iterations 100\n"
                        "  Multiple runs:        ./myapp --mode A && ./myapp --mode B\n"
                        "  Piped input:          ./myapp < test_data/input.dat\n"
                        "\n"
                ...
                Tool(
                    ...
                    description=(
                        ...
                        "execution is. If the binary accepts input, use a workload that exercises the "
                        "loops you care about. Multiple configurations with different inputs can be "
                        "created and run independently to profile different code paths. "
                        "\n\n"
