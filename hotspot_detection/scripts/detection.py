...
def main():
    ...
    for x in NZcslist:
        ...
        if x.maxVal >= 0.01 * maxCS.maxVal:
            counterD1 += 1
            yesno = " is YES"
        f1.write(str(x.csid) + " " + str(x.name) + " at " + str(x.fid) + ":" + str(x.lineNum) + yesno + "\n")
    ...
    for x in sortedCsAvr:
        ...
        if accum <= maxCS.maxVal * 2:
            yesno = " is YES"
            counterD2 += 1
        f2.write(str(x.csid) + " " + str(x.name) + " at " + str(x.fid) + ":" + str(x.lineNum) + yesno + "\n")
    ...
    for x in NZcslist:
        ...
        if x.delta > x.avr:
            ...
            yesno = " is YES"
            counterD4 += 1
        f4.write(str(x.csid) + " " + str(x.name) + " at " + str(x.fid) + ":" + str(x.lineNum) + yesno + "\n")
    ...
    for x in NZcslist:
        ...
        if x.maxVal / x.minVal > 1:
            yesno = " is YES"
            counterD5 += 1
        f5.write(str(x.csid) + " " + str(x.name) + " at " + str(x.fid) + ":" + str(x.lineNum) + yesno + "\n")
