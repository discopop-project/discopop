...
def __check_pragma_for_exception_rules(data_race: DataRace, pet) -> bool:
...
#    is_valid = is_valid and __for_exception_rule_2(data_race, pet, parallelization_suggestions)
    return is_valid
...
#def __for_exception_rule_2(data_race: DataRace, pet, parallelization_suggestions) -> bool:
