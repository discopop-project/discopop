...
def extract_postprocessed_behavior_models(run_configuration: Configuration, pet, tcs, pragma: OmpPragma, omp_pragmas: List[OmpPragma]) -> List[BehaviorModel]:
...
def __extract_behavior_models(run_configuration: Configuration, pet, tcs, pragma: OmpPragma, omp_pragmas: List[OmpPragma]) -> List[BehaviorModel]:
