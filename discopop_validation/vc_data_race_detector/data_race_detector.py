from discopop_validation.vc_data_race_detector.classes.detector_state import State
from .classes.data_race import DataRace
from ..data_race_prediction.behavior_modeller.classes.Operation import Operation
from typing import Dict, List, Tuple, Optional
from discopop_validation.vc_data_race_detector.classes.vector_clock import get_updated_vc, increase, compare_vc
from discopop_validation.data_race_prediction.scheduler.classes.Schedule import Schedule
from ..data_race_prediction.scheduler.classes.ScheduleElement import ScheduleElement
from ..data_race_prediction.scheduler.classes.UpdateType import UpdateType
