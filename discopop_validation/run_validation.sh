...
python -m discopop_validation --path=${PWD}/discopop_validation/test/code_samples/simple_doall/path_1_op_9 --dep-file=out_dep.txt --ll-file=out_dp_inst.ll --json=original_suggestions.json --verbose=true --dp-build-path=/home/lukas/git/discopop/build/ --thread-count=7 --call-graph=/home/lukas/Schreibtisch/cg.png --data-race-output=data_races.txt --validation-time-limit=3
