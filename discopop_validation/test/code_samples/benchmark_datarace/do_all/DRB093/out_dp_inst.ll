...
entry:
  ...
  call void @__dp_write(i32 16441, i64 %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
...
for.cond:                                         ; preds = %for.inc10, %entry
  ...
  call void @__dp_read(i32 16441, i64 %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_write(i32 16442, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  call void @__dp_read(i32 16442, i64 %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
...
for.body3:                                        ; preds = %for.cond1
  ...
  call void @__dp_read(i32 16443, i64 %6, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  ...
  call void @__dp_read(i32 16443, i64 %10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %11 = load i32, i32* %arrayidx5, align 4, !dbg !36
  %add = add nsw i32 %11, 1, !dbg !38
  %12 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16443, i64 %12, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  ...
  call void @__dp_read(i32 16443, i64 %14, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16443, i64 %16, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  store i32 %add, i32* %arrayidx9, align 4, !dbg !42
  br label %for.inc, !dbg !40

for.inc:                                          ; preds = %for.body3
  %17 = ptrtoint i32* %j to i64
  call void @__dp_read(i32 16442, i64 %17, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %18 = load i32, i32* %j, align 4, !dbg !43
  %inc = add nsw i32 %18, 1, !dbg !43
  %19 = ptrtoint i32* %j to i64
  call void @__dp_write(i32 16442, i64 %19, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
...
for.inc10:                                        ; preds = %for.end
  ...
  call void @__dp_read(i32 16441, i64 %20, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %21 = load i32, i32* %i, align 4, !dbg !47
  %inc11 = add nsw i32 %21, 1, !dbg !47
  %22 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16441, i64 %22, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
