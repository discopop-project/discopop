...
for.body3:                                        ; preds = %for.cond1
  ...
  call void @add_ptr_instr_rec(i32 60, i64 1, i32 0, i64 %4)
  %5 = ptrtoint i32* %arrayidx5 to i64
  call void @add_ptr_instr_rec(i32 59, i64 2, i32 0, i64 %5)
  ...
  call void @add_ptr_instr_rec(i32 60, i64 1, i32 1, i64 %9)
  %10 = ptrtoint i32* %arrayidx9 to i64
  call void @add_ptr_instr_rec(i32 59, i64 2, i32 1, i64 %10)
