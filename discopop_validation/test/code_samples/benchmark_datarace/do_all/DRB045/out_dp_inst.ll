...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  call void @__dp_read(i32 16439, i64 %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %2 = load i32, i32* %i, align 4, !dbg !22
  %cmp = icmp slt i32 %2, 100, !dbg !24
  br i1 %cmp, label %for.body, label %for.end, !dbg !25

for.body:                                         ; preds = %for.cond
  %3 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16440, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  ...
  call void @__dp_read(i32 16440, i64 %5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %6 = load i32, i32* %arrayidx, align 4, !dbg !27
  %add = add nsw i32 %6, 1, !dbg !28
  %7 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16440, i64 %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %8 = load i32, i32* %i, align 4, !dbg !29
  %idxprom1 = sext i32 %8 to i64, !dbg !30
  %arrayidx2 = getelementptr inbounds [100 x i32], [100 x i32]* @a, i64 0, i64 %idxprom1, !dbg !30
  %9 = ptrtoint i32* %arrayidx2 to i64
  call void @__dp_write(i32 16440, i64 %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  store i32 %add, i32* %arrayidx2, align 4, !dbg !31
  br label %for.inc, !dbg !30

for.inc:                                          ; preds = %for.body
  %10 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16439, i64 %10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %11 = load i32, i32* %i, align 4, !dbg !32
  %inc = add nsw i32 %11, 1, !dbg !32
  %12 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16439, i64 %12, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
