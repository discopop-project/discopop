...
@bots_arg_size = dso_local global i32 14, align 4, !dbg !34
...
@.str.3 = private unnamed_addr constant [27 x i8] c"  -n <size>  : Board size\0A\00", align 1
...
@.str.21 = private unnamed_addr constant [9 x i8] c"N Queens\00", align 1
...
entry:
  ...
  %call4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.3, i32 0, i32 0)), !dbg !85
...
entry:
  %call = call i32 (i8*, i64, i8*, ...) @snprintf(i8* getelementptr inbounds ([256 x i8], [256 x i8]* @bots_name, i32 0, i32 0), i64 256, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.21, i32 0, i32 0)) #6, !dbg !274
...
entry:
  ...
  call void @find_queens(i32 %2), !dbg !305
...
if.then:                                          ; preds = %entry
  %6 = load i32, i32* @bots_arg_size, align 4, !dbg !317
  %call2 = call i32 @verify_queens(i32 %6), !dbg !317
  store i32 %call2, i32* @bots_result, align 4, !dbg !319
  br label %if.end, !dbg !320

if.end:                                           ; preds = %if.then, %entry
  call void @bots_print_results(), !dbg !321
  call void @loop_counter_output(), !dbg !322
  ret i32 0, !dbg !322
}

declare dso_local i64 @bots_usecs(...) #1

declare dso_local void @find_queens(i32) #1

declare dso_local i32 @verify_queens(i32) #1
...
!3 = !DIFile(filename: "bots_main.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/bots_reduced/serial/nqueens")
!4 = !{!5}
...
!317 = !DILocation(line: 522, column: 20, scope: !318)
!318 = distinct !DILexicalBlock(scope: !315, file: !3, line: 521, column: 25)
!319 = !DILocation(line: 522, column: 18, scope: !318)
!320 = !DILocation(line: 523, column: 4, scope: !318)
!321 = !DILocation(line: 528, column: 4, scope: !287)
!322 = !DILocation(line: 529, column: 4, scope: !287)
