...
#clang++ -g -O0 -emit-llvm -fno-discard-value-names -c sort.c -o tmp_target_app.ll
...
clang++ tmp_target_app_instrumented.ll iFunctions_CUInst.ll -o sort_cui -L/home/lukas/git/discopop/build/rtlib -lDiscoPoP_RT -lpthread -o sort_cui
...
--cu-inst-res=sort_cui_CUInstResult.txt \
--task-pattern
