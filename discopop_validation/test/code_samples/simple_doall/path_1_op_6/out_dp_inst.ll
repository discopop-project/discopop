...
for.inc:                                          ; preds = %for.body
  ...
  call void @__dp_read(i32 16390, i64 %25, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %26 = load i32, i32* %i, align 4, !dbg !44
  %inc = add nsw i32 %26, 1, !dbg !44
  %27 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16390, i64 %27, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
...
for.end:                                          ; preds = %for.cond
  ...
  call void @__dp_read(i32 16396, i64 %28, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0))
  %29 = load i32, i32* %retval, align 4, !dbg !48
  call void @__dp_finalize(i32 16396), !dbg !48
  ret i32 %29, !dbg !48
}
...
!1 = !DIFile(filename: "simple_doall.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/simple_doall/path_1_op_6")
!2 = !{}
...
!43 = !DILocation(line: 10, column: 5, scope: !27)
!44 = !DILocation(line: 6, column: 31, scope: !23)
!45 = !DILocation(line: 6, column: 5, scope: !23)
!46 = distinct !{!46, !25, !47}
!47 = !DILocation(line: 10, column: 5, scope: !19)
!48 = !DILocation(line: 12, column: 1, scope: !7)
