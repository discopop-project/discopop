...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_write(i32 16394, i64 %27, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0))
  store i32 6, i32* %arrayidx10, align 4, !dbg !45
  br label %for.inc, !dbg !46

for.inc:                                          ; preds = %for.body
  %28 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16390, i64 %28, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %29 = load i32, i32* %i, align 4, !dbg !47
  %inc = add nsw i32 %29, 1, !dbg !47
  %30 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16390, i64 %30, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
...
for.end:                                          ; preds = %for.cond
  ...
  call void @__dp_read(i32 16397, i64 %31, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0))
  %32 = load i32, i32* %retval, align 4, !dbg !51
  call void @__dp_finalize(i32 16397), !dbg !51
  ret i32 %32, !dbg !51
}
...
!1 = !DIFile(filename: "simple_doall.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/simple_doall/path_1_op_7")
!2 = !{}
...
!43 = !DILocation(line: 10, column: 13, scope: !27)
!44 = !DILocation(line: 10, column: 9, scope: !27)
!45 = !DILocation(line: 10, column: 16, scope: !27)
!46 = !DILocation(line: 11, column: 5, scope: !27)
!47 = !DILocation(line: 6, column: 31, scope: !23)
!48 = !DILocation(line: 6, column: 5, scope: !23)
!49 = distinct !{!49, !25, !50}
!50 = !DILocation(line: 11, column: 5, scope: !19)
