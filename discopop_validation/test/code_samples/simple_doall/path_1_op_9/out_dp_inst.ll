...
for.inc:                                          ; preds = %for.body
  ...
  call void @__dp_read(i32 16390, i64 %36, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %37 = load i32, i32* %i, align 4, !dbg !54
  %inc = add nsw i32 %37, 1, !dbg !54
  %38 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16390, i64 %38, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  store i32 %inc, i32* %i, align 4, !dbg !54
  br label %for.cond, !dbg !55, !llvm.loop !56

for.end:                                          ; preds = %for.cond
  call void @__dp_loop_exit(i32 16397, i32 0)
  %39 = ptrtoint i32* %retval to i64
  call void @__dp_read(i32 16397, i64 %39, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0))
  %40 = load i32, i32* %retval, align 4, !dbg !58
  call void @__dp_finalize(i32 16397), !dbg !58
  ret i32 %40, !dbg !58
}
...
!1 = !DIFile(filename: "simple_doall.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/simple_doall/path_1_op_9")
!2 = !{}
...
!53 = !DILocation(line: 11, column: 5, scope: !27)
!54 = !DILocation(line: 6, column: 31, scope: !23)
!55 = !DILocation(line: 6, column: 5, scope: !23)
!56 = distinct !{!56, !25, !57}
!57 = !DILocation(line: 11, column: 5, scope: !19)
