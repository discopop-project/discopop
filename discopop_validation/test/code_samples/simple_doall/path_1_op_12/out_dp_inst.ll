...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_read(i32 16394, i64 %31, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0))
  %32 = load i32, i32* %arrayidx13, align 4, !dbg !47
  %rem14 = srem i32 %32, 3, !dbg !48
  %sub15 = sub nsw i32 %add11, %rem14, !dbg !49
  %33 = ptrtoint i32* %x to i64
  call void @__dp_read(i32 16394, i64 %33, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %34 = load i32, i32* %x, align 4, !dbg !50
  %idxprom16 = sext i32 %34 to i64, !dbg !51
  %arrayidx17 = getelementptr inbounds [10 x i32], [10 x i32]* %arr, i64 0, i64 %idxprom16, !dbg !51
  %35 = ptrtoint i32* %arrayidx17 to i64
  call void @__dp_write(i32 16394, i64 %35, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0))
  store i32 %sub15, i32* %arrayidx17, align 4, !dbg !52
  %36 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16395, i64 %36, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %37 = load i32, i32* %i, align 4, !dbg !53
  %38 = ptrtoint i32* %x to i64
  call void @__dp_read(i32 16395, i64 %38, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %39 = load i32, i32* %x, align 4, !dbg !54
  %idxprom18 = sext i32 %39 to i64, !dbg !55
  %arrayidx19 = getelementptr inbounds [10 x i32], [10 x i32]* %arr, i64 0, i64 %idxprom18, !dbg !55
  %40 = ptrtoint i32* %arrayidx19 to i64
  call void @__dp_write(i32 16395, i64 %40, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0))
  store i32 %37, i32* %arrayidx19, align 4, !dbg !56
  %41 = ptrtoint i32* %x to i64
  call void @__dp_read(i32 16396, i64 %41, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %42 = load i32, i32* %x, align 4, !dbg !57
  %idxprom20 = sext i32 %42 to i64, !dbg !58
  %arrayidx21 = getelementptr inbounds [10 x i32], [10 x i32]* %arr, i64 0, i64 %idxprom20, !dbg !58
  %43 = ptrtoint i32* %arrayidx21 to i64
  call void @__dp_read(i32 16396, i64 %43, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0))
  %44 = load i32, i32* %arrayidx21, align 4, !dbg !59
  %add22 = add nsw i32 %44, 3, !dbg !59
  %45 = ptrtoint i32* %arrayidx21 to i64
  call void @__dp_write(i32 16396, i64 %45, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0))
  store i32 %add22, i32* %arrayidx21, align 4, !dbg !59
  br label %for.inc, !dbg !60

for.inc:                                          ; preds = %for.body
  %46 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16390, i64 %46, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %47 = load i32, i32* %i, align 4, !dbg !61
  %inc = add nsw i32 %47, 1, !dbg !61
  %48 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16390, i64 %48, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
...
for.end:                                          ; preds = %for.cond
  ...
  call void @__dp_read(i32 16399, i64 %49, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0))
  %50 = load i32, i32* %retval, align 4, !dbg !65
  call void @__dp_finalize(i32 16399), !dbg !65
  ret i32 %50, !dbg !65
}
...
!1 = !DIFile(filename: "simple_doall.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/simple_doall/path_1_op_12")
!2 = !{}
...
!43 = !DILocation(line: 10, column: 26, scope: !27)
!44 = !DILocation(line: 10, column: 22, scope: !27)
!45 = !DILocation(line: 10, column: 20, scope: !27)
!46 = !DILocation(line: 10, column: 36, scope: !27)
!47 = !DILocation(line: 10, column: 32, scope: !27)
!48 = !DILocation(line: 10, column: 39, scope: !27)
!49 = !DILocation(line: 10, column: 29, scope: !27)
!50 = !DILocation(line: 10, column: 13, scope: !27)
!51 = !DILocation(line: 10, column: 9, scope: !27)
!52 = !DILocation(line: 10, column: 16, scope: !27)
!53 = !DILocation(line: 11, column: 18, scope: !27)
!54 = !DILocation(line: 11, column: 13, scope: !27)
!55 = !DILocation(line: 11, column: 9, scope: !27)
!56 = !DILocation(line: 11, column: 16, scope: !27)
!57 = !DILocation(line: 12, column: 13, scope: !27)
!58 = !DILocation(line: 12, column: 9, scope: !27)
!59 = !DILocation(line: 12, column: 16, scope: !27)
!60 = !DILocation(line: 13, column: 5, scope: !27)
!61 = !DILocation(line: 6, column: 31, scope: !23)
!62 = !DILocation(line: 6, column: 5, scope: !23)
!63 = distinct !{!63, !25, !64}
!64 = !DILocation(line: 13, column: 5, scope: !19)
!65 = !DILocation(line: 15, column: 1, scope: !7)
