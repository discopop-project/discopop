...
for.body:                                         ; preds = %for.cond
  ...
  %13 = load i32, i32* %arrayidx13, align 4, !dbg !47
  %rem14 = srem i32 %13, 3, !dbg !48
  %sub15 = sub nsw i32 %add11, %rem14, !dbg !49
  %14 = load i32, i32* %x, align 4, !dbg !50
  %idxprom16 = sext i32 %14 to i64, !dbg !51
  ...
  %15 = load i32, i32* %i, align 4, !dbg !53
  %16 = load i32, i32* %x, align 4, !dbg !54
  %idxprom18 = sext i32 %16 to i64, !dbg !55
  %arrayidx19 = getelementptr inbounds [10 x i32], [10 x i32]* %arr, i64 0, i64 %idxprom18, !dbg !55
  store i32 %15, i32* %arrayidx19, align 4, !dbg !56
  %17 = load i32, i32* %x, align 4, !dbg !57
  %idxprom20 = sext i32 %17 to i64, !dbg !58
  %arrayidx21 = getelementptr inbounds [10 x i32], [10 x i32]* %arr, i64 0, i64 %idxprom20, !dbg !58
  %18 = load i32, i32* %arrayidx21, align 4, !dbg !59
  %add22 = add nsw i32 %18, 3, !dbg !59
...
for.end:                                          ; preds = %for.cond
  %20 = load i32, i32* %retval, align 4, !dbg !65
  call void @loop_counter_output(), !dbg !65
  ret i32 %20, !dbg !65
}
