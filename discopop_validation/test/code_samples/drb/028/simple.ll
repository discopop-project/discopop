...
for.end10:                                        ; preds = %for.cond1
  ...
  %13 = load i32, i32* %arrayidx11, align 8, !dbg !68
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 %13), !dbg !69
  ret i32 0, !dbg !70
}
