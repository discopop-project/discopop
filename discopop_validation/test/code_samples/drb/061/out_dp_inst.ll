...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_write(i32 16443, i64 %3, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0))
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %cmp2 = icmp slt i32 %6, 100, !dbg !44
...
for.inc12:                                        ; preds = %for.end
  ...
  call void @__dp_read(i32 16441, i64 %28, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %29 = load i32, i32* %i, align 4, !dbg !64
  %inc13 = add nsw i32 %29, 1, !dbg !64
  %30 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16441, i64 %30, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
...
entry:
  call void @__dp_func_entry(i32 16453, i32 1)
  %retval = alloca i32, align 4
  %0 = ptrtoint i32* %retval to i64
  call void @__dp_write(i32 16453, i64 %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i32 0, i32 0))
  store i32 0, i32* %retval, align 4
  call void @__dp_call(i32 16455), !dbg !70
  %call = call i32 @mv(), !dbg !70
  call void @__dp_finalize(i32 16456), !dbg !71
  ret i32 0, !dbg !71
}
