...
@.str.11 = private unnamed_addr constant [6 x i8] c"pfile\00", align 1
...
entry:
  ...
  call void @__dp_write(i32 16435, i64 %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i32 0, i32 0))
  store i32 0, i32* %retval, align 4
  %1 = ptrtoint i32* %argc.addr to i64
  call void @__dp_write(i32 16435, i64 %1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16435, i64 %2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.7, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16440, i64 %3, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.8, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16444, i64 %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  call void @__dp_read(i32 16444, i64 %5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
  %6 = load i32, i32* %i, align 4, !dbg !95
  %7 = ptrtoint i32* %len to i64
  call void @__dp_read(i32 16444, i64 %7, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.8, i32 0, i32 0))
  %8 = load i32, i32* %len, align 4, !dbg !97
  %cmp = icmp slt i32 %6, %8, !dbg !98
  br i1 %cmp, label %for.body, label %for.end, !dbg !99

for.body:                                         ; preds = %for.cond
  %9 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16445, i64 %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
  %10 = load i32, i32* %i, align 4, !dbg !100
  %11 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16445, i64 %11, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
  %12 = load i32, i32* %i, align 4, !dbg !101
  %idxprom = sext i32 %12 to i64, !dbg !102
  %arrayidx = getelementptr inbounds [1000 x i32], [1000 x i32]* %A, i64 0, i64 %idxprom, !dbg !102
  %13 = ptrtoint i32* %arrayidx to i64
  call void @__dp_write(i32 16445, i64 %13, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0))
  store i32 %10, i32* %arrayidx, align 4, !dbg !103
  br label %for.inc, !dbg !102

for.inc:                                          ; preds = %for.body
  %14 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16444, i64 %14, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
  %15 = load i32, i32* %i, align 4, !dbg !104
  %inc = add nsw i32 %15, 1, !dbg !104
  %16 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16444, i64 %16, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
  store i32 %inc, i32* %i, align 4, !dbg !104
  br label %for.cond, !dbg !105, !llvm.loop !106

for.end:                                          ; preds = %for.cond
  call void @__dp_loop_exit(i32 16447, i32 0)
  call void @__dp_call(i32 16447), !dbg !108
  ...
  %17 = ptrtoint %struct._IO_FILE** %pfile to i64
  call void @__dp_write(i32 16447, i64 %17, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.11, i32 0, i32 0))
  store %struct._IO_FILE* %call, %struct._IO_FILE** %pfile, align 8, !dbg !109
  %18 = ptrtoint %struct._IO_FILE** %pfile to i64
  call void @__dp_read(i32 16448, i64 %18, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.11, i32 0, i32 0))
  %19 = load %struct._IO_FILE*, %struct._IO_FILE** %pfile, align 8, !dbg !110
  %cmp1 = icmp eq %struct._IO_FILE* %19, null, !dbg !112
  br i1 %cmp1, label %if.then, label %if.end, !dbg !113

if.then:                                          ; preds = %for.end
  %20 = ptrtoint %struct._IO_FILE** @stderr to i64
  call void @__dp_read(i32 16450, i64 %20, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.12, i32 0, i32 0))
  %21 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !114
  call void @__dp_call(i32 16450), !dbg !116
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %21, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.2, i64 0, i64 0)), !dbg !116
  br label %if.end, !dbg !117

if.end:                                           ; preds = %if.then, %for.end
  %22 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16454, i64 %22, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
...
for.cond3:                                        ; preds = %for.inc9, %if.end
  ...
  call void @__dp_read(i32 16454, i64 %23, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
  %24 = load i32, i32* %i, align 4, !dbg !121
  %25 = ptrtoint i32* %len to i64
  call void @__dp_read(i32 16454, i64 %25, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.8, i32 0, i32 0))
  %26 = load i32, i32* %len, align 4, !dbg !123
  %cmp4 = icmp slt i32 %24, %26, !dbg !124
  br i1 %cmp4, label %for.body5, label %for.end11, !dbg !125

for.body5:                                        ; preds = %for.cond3
  %27 = ptrtoint %struct._IO_FILE** %pfile to i64
  call void @__dp_read(i32 16456, i64 %27, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.11, i32 0, i32 0))
  %28 = load %struct._IO_FILE*, %struct._IO_FILE** %pfile, align 8, !dbg !126
  %29 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16456, i64 %29, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
  %30 = load i32, i32* %i, align 4, !dbg !128
  %idxprom6 = sext i32 %30 to i64, !dbg !129
  %arrayidx7 = getelementptr inbounds [1000 x i32], [1000 x i32]* %A, i64 0, i64 %idxprom6, !dbg !129
  %31 = ptrtoint i32* %arrayidx7 to i64
  call void @__dp_read(i32 16456, i64 %31, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0))
  %32 = load i32, i32* %arrayidx7, align 4, !dbg !129
  call void @__dp_call(i32 16456), !dbg !130
  %call8 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32 %32), !dbg !130
  br label %for.inc9, !dbg !131

for.inc9:                                         ; preds = %for.body5
  %33 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16454, i64 %33, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
  %34 = load i32, i32* %i, align 4, !dbg !132
  %inc10 = add nsw i32 %34, 1, !dbg !132
  %35 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16454, i64 %35, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
...
for.end11:                                        ; preds = %for.cond3
  ...
  %36 = ptrtoint %struct._IO_FILE** %pfile to i64
  call void @__dp_read(i32 16459, i64 %36, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.11, i32 0, i32 0))
  %37 = load %struct._IO_FILE*, %struct._IO_FILE** %pfile, align 8, !dbg !136
  call void @__dp_call(i32 16459), !dbg !137
  %call12 = call i32 @fclose(%struct._IO_FILE* %37), !dbg !137
  call void @__dp_call(i32 16460), !dbg !138
  %call13 = call i32 @remove(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0)) #4, !dbg !138
  %38 = ptrtoint i32* %ret to i64
  call void @__dp_write(i32 16460, i64 %38, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.13, i32 0, i32 0))
  store i32 %call13, i32* %ret, align 4, !dbg !139
  %39 = ptrtoint i32* %ret to i64
  call void @__dp_read(i32 16461, i64 %39, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.13, i32 0, i32 0))
  %40 = load i32, i32* %ret, align 4, !dbg !140
  %cmp14 = icmp ne i32 %40, 0, !dbg !142
  br i1 %cmp14, label %if.then15, label %if.end17, !dbg !143

if.then15:                                        ; preds = %for.end11
  %41 = ptrtoint %struct._IO_FILE** @stderr to i64
  call void @__dp_read(i32 16463, i64 %41, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.12, i32 0, i32 0))
  %42 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !144
  call void @__dp_call(i32 16463), !dbg !146
  %call16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %42, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.4, i64 0, i64 0)), !dbg !146
  br label %if.end17, !dbg !147

if.end17:                                         ; preds = %if.then15, %for.end11
  call void @__dp_finalize(i32 16465), !dbg !148
  ret i32 0, !dbg !148
}
