...
for.body:                                         ; preds = %for.cond
  %1 = load i32, i32* %var, align 4, !dbg !21
...
for.end:                                          ; preds = %for.cond
  %3 = load i32, i32* %var, align 4, !dbg !28
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %3), !dbg !29
  ret i32 0, !dbg !30
}
