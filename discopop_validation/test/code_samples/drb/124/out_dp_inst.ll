...
entry:
  ...
  call void @__dp_read(i32 16420, i64 %4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0))
  %5 = load i32, i32* %init, align 4, !dbg !25
  %6 = ptrtoint i32* %local to i64
  call void @__dp_write(i32 16420, i64 %6, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i32 0, i32 0))
  store i32 %5, i32* %local, align 4, !dbg !26
  call void @__dp_finalize(i32 16423), !dbg !27
  ret i32 0, !dbg !27
}
