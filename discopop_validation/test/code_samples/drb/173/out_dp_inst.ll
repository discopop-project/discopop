...
entry:
  ...
  call void @__dp_write(i32 16406, i64 %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  store i32 0, i32* %a, align 4, !dbg !12
  %1 = ptrtoint i32* %a to i64
  call void @__dp_read(i32 16414, i64 %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %2 = load i32, i32* %a, align 4, !dbg !13
  %inc = add nsw i32 %2, 1, !dbg !13
  %3 = ptrtoint i32* %a to i64
  call void @__dp_write(i32 16414, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  store i32 %inc, i32* %a, align 4, !dbg !13
  %4 = ptrtoint i32* %a to i64
  call void @__dp_read(i32 16420, i64 %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %5 = load i32, i32* %a, align 4, !dbg !16
  %inc1 = add nsw i32 %5, 1, !dbg !16
  %6 = ptrtoint i32* %a to i64
  call void @__dp_write(i32 16420, i64 %6, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  store i32 %inc1, i32* %a, align 4, !dbg !16
  %7 = ptrtoint i32* %a to i64
  call void @__dp_read(i32 16424, i64 %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %8 = load i32, i32* %a, align 4, !dbg !18
  call void @__dp_call(i32 16424), !dbg !19
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %8), !dbg !19
  call void @__dp_func_exit(i32 16425, i32 0), !dbg !20
  ret void, !dbg !20
}
...
entry:
  call void @__dp_func_entry(i32 16427, i32 1)
  %retval = alloca i32, align 4
  %0 = ptrtoint i32* %retval to i64
  call void @__dp_write(i32 16427, i64 %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0))
  store i32 0, i32* %retval, align 4
  call void @__dp_call(i32 16428), !dbg !24
  call void @foo(), !dbg !24
  call void @__dp_finalize(i32 16430), !dbg !25
  ret i32 0, !dbg !25
}
