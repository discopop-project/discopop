...
if.end:                                           ; preds = %if.then, %entry
  ...
  call void @__dp_write(i32 16446, i64 %17, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
...
for.cond:                                         ; preds = %for.inc, %if.end
  ...
  call void @__dp_read(i32 16446, i64 %18, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %19 = load i32, i32* %i, align 4, !dbg !43
  %20 = ptrtoint i32* %len to i64
  call void @__dp_read(i32 16446, i64 %20, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_read(i32 16447, i64 %22, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %23 = load i32, i32* %i, align 4, !dbg !48
  %24 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16447, i64 %24, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16447, i64 %26, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
  store i32 %23, i32* %arrayidx2, align 4, !dbg !51
  br label %for.inc, !dbg !50

for.inc:                                          ; preds = %for.body
  %27 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16446, i64 %27, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %28 = load i32, i32* %i, align 4, !dbg !52
  %inc = add nsw i32 %28, 1, !dbg !52
  %29 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16446, i64 %29, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
...
for.cond3:                                        ; preds = %for.inc11, %for.end
  call void @__dp_loop_entry(i32 16450, i32 1)
  ...
  call void @__dp_read(i32 16450, i64 %33, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
...
for.body5:                                        ; preds = %for.cond3
  ...
  call void @__dp_read(i32 16451, i64 %35, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %36 = load i32, i32* %i, align 4, !dbg !65
  %add = add nsw i32 %36, 1, !dbg !66
  %idxprom6 = sext i32 %add to i64, !dbg !67
  %arrayidx7 = getelementptr inbounds i32, i32* %vla, i64 %idxprom6, !dbg !67
  %37 = ptrtoint i32* %arrayidx7 to i64
  call void @__dp_read(i32 16451, i64 %37, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
  %38 = load i32, i32* %arrayidx7, align 4, !dbg !67
  %add8 = add nsw i32 %38, 1, !dbg !68
  %39 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16451, i64 %39, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %40 = load i32, i32* %i, align 4, !dbg !69
  %idxprom9 = sext i32 %40 to i64, !dbg !70
  %arrayidx10 = getelementptr inbounds i32, i32* %vla, i64 %idxprom9, !dbg !70
  %41 = ptrtoint i32* %arrayidx10 to i64
  call void @__dp_write(i32 16451, i64 %41, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
  store i32 %add8, i32* %arrayidx10, align 4, !dbg !71
...
for.inc11:                                        ; preds = %for.body5
  ...
  call void @__dp_write(i32 16450, i64 %44, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
...
for.end13:                                        ; preds = %for.cond3
  ...
  call void @__dp_write(i32 16453, i64 %45, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0))
  store i32 0, i32* %retval, align 4, !dbg !76
  %46 = ptrtoint i8** %saved_stack to i64
  call void @__dp_read(i32 16454, i64 %46, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4, i32 0, i32 0))
  %47 = load i8*, i8** %saved_stack, align 8, !dbg !77
  call void @__dp_call(i32 16454), !dbg !77
  call void @llvm.stackrestore(i8* %47), !dbg !77
  %48 = ptrtoint i32* %retval to i64
  call void @__dp_read(i32 16454, i64 %48, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0))
  %49 = load i32, i32* %retval, align 4, !dbg !77
  call void @__dp_finalize(i32 16454), !dbg !77
  ret i32 %49, !dbg !77
}
...
!1 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/002")
!2 = !{}
...
!56 = !DILocation(line: 66, column: 9, scope: !57)
!57 = distinct !DILexicalBlock(scope: !7, file: !1, line: 66, column: 3)
!58 = !DILocation(line: 66, column: 8, scope: !57)
!59 = !DILocation(line: 66, column: 12, scope: !60)
!60 = distinct !DILexicalBlock(scope: !57, file: !1, line: 66, column: 3)
!61 = !DILocation(line: 66, column: 15, scope: !60)
!62 = !DILocation(line: 66, column: 19, scope: !60)
!63 = !DILocation(line: 66, column: 13, scope: !60)
!64 = !DILocation(line: 66, column: 3, scope: !57)
!65 = !DILocation(line: 67, column: 12, scope: !60)
!66 = !DILocation(line: 67, column: 13, scope: !60)
!67 = !DILocation(line: 67, column: 10, scope: !60)
!68 = !DILocation(line: 67, column: 16, scope: !60)
!69 = !DILocation(line: 67, column: 7, scope: !60)
!70 = !DILocation(line: 67, column: 5, scope: !60)
!71 = !DILocation(line: 67, column: 9, scope: !60)
!72 = !DILocation(line: 66, column: 24, scope: !60)
!73 = !DILocation(line: 66, column: 3, scope: !60)
!74 = distinct !{!74, !64, !75}
!75 = !DILocation(line: 67, column: 17, scope: !57)
!76 = !DILocation(line: 69, column: 3, scope: !7)
