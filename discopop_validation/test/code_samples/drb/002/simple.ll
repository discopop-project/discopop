...
for.inc11:                                        ; preds = %for.body5
  ...
  %inc12 = add nsw i32 %16, 1, !dbg !72
  store i32 %inc12, i32* %i, align 4, !dbg !72
  br label %for.cond3, !dbg !73, !llvm.loop !74

for.end13:                                        ; preds = %for.cond3
  store i32 0, i32* %retval, align 4, !dbg !76
  %17 = load i8*, i8** %saved_stack, align 8, !dbg !77
  call void @llvm.stackrestore(i8* %17), !dbg !77
  %18 = load i32, i32* %retval, align 4, !dbg !77
  ret i32 %18, !dbg !77
}
