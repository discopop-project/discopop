...
entry:
  ...
  call void @__dp_write(i32 16443, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
...
entry:
  ...
  call void @__dp_write(i32 16448, i64 %2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i32 0, i32 0))
  store i32 0, i32* %sum, align 4, !dbg !23
  call void @__dp_call(i32 16451), !dbg !24
  call void @f1(i32* %i), !dbg !24
  %3 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16452, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  %4 = load i32, i32* %i, align 4, !dbg !26
  %5 = ptrtoint i32* %sum to i64
  call void @__dp_read(i32 16452, i64 %5, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i32 0, i32 0))
  %6 = load i32, i32* %sum, align 4, !dbg !27
  %add = add nsw i32 %6, %4, !dbg !27
  %7 = ptrtoint i32* %sum to i64
  call void @__dp_write(i32 16452, i64 %7, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i32 0, i32 0))
  store i32 %add, i32* %sum, align 4, !dbg !27
  %8 = ptrtoint i32* %sum to i64
  call void @__dp_read(i32 16455, i64 %8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i32 0, i32 0))
  %9 = load i32, i32* %sum, align 4, !dbg !28
  call void @__dp_call(i32 16455), !dbg !29
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i32 %9), !dbg !29
  call void @__dp_finalize(i32 16456), !dbg !30
  ret i32 0, !dbg !30
}
