...
for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32, i32* %i1, align 4, !dbg !19
  %cmp = icmp slt i32 %0, 100, !dbg !21
  br i1 %cmp, label %for.body, label %for.end, !dbg !22

for.body:                                         ; preds = %for.cond
  %1 = load i32, i32* %var, align 4, !dbg !23
  %inc = add nsw i32 %1, 1, !dbg !23
  store i32 %inc, i32* %var, align 4, !dbg !23
  br label %for.inc, !dbg !25

for.inc:                                          ; preds = %for.body
  %2 = load i32, i32* %i1, align 4, !dbg !26
  %inc2 = add nsw i32 %2, 1, !dbg !26
  store i32 %inc2, i32* %i1, align 4, !dbg !26
  br label %for.cond, !dbg !27, !llvm.loop !28

for.end:                                          ; preds = %for.cond
  %3 = load i32, i32* %var, align 4, !dbg !30
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %3), !dbg !31
  ret i32 0, !dbg !32
}
