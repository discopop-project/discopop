...
entry:
  ...
  call void @__dp_write(i32 16438, i64 %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  store i32 0, i32* %i, align 4, !dbg !12
  %2 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16442, i64 %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  store i32 1, i32* %i, align 4, !dbg !13
  %3 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16444, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  store i32 2, i32* %i, align 4, !dbg !15
  %4 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16446, i64 %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %5 = load i32, i32* %i, align 4, !dbg !16
  call void @__dp_call(i32 16446), !dbg !17
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %5), !dbg !17
  call void @__dp_finalize(i32 16447), !dbg !18
  ret i32 0, !dbg !18
}
...
!1 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/023")
!2 = !{}
...
!13 = !DILocation(line: 58, column: 7, scope: !14)
!14 = distinct !DILexicalBlock(scope: !7, file: !1, line: 56, column: 3)
!15 = !DILocation(line: 60, column: 7, scope: !14)
!16 = !DILocation(line: 62, column: 19, scope: !7)
