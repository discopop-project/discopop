...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32 %0), !dbg !23
  ret i32 0, !dbg !24
}
...
!1 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/051")
!2 = !{}
...
!13 = !DILocation(line: 58, column: 10, scope: !14)
!14 = distinct !DILexicalBlock(scope: !15, file: !1, line: 58, column: 10)
!15 = distinct !DILexicalBlock(scope: !7, file: !1, line: 57, column: 3)
!16 = !DILocation(line: 58, column: 30, scope: !14)
!17 = !DILocation(line: 58, column: 10, scope: !15)
!18 = !DILocation(line: 59, column: 20, scope: !19)
!19 = distinct !DILexicalBlock(scope: !14, file: !1, line: 58, column: 36)
!20 = !DILocation(line: 59, column: 18, scope: !19)
!21 = !DILocation(line: 60, column: 5, scope: !19)
!22 = !DILocation(line: 62, column: 30, scope: !7)
!23 = !DILocation(line: 62, column: 3, scope: !7)
!24 = !DILocation(line: 63, column: 3, scope: !7)
