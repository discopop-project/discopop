...
entry:
  ...
  call void @__dp_write(i32 16404, i64 %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16404, i64 %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16407, i64 %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  store i32 %inc, i32* %x, align 4, !dbg !15
  %5 = ptrtoint i32* %y to i64
  call void @__dp_read(i32 16410, i64 %5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  %6 = load i32, i32* %y, align 4, !dbg !16
  %dec = add nsw i32 %6, -1, !dbg !16
  %7 = ptrtoint i32* %y to i64
  call void @__dp_write(i32 16410, i64 %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  store i32 %dec, i32* %y, align 4, !dbg !16
  %8 = ptrtoint i32* %x to i64
  call void @__dp_read(i32 16414, i64 %8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %9 = load i32, i32* %x, align 4, !dbg !17
  call void @__dp_call(i32 16414), !dbg !18
  ...
  call void @__dp_func_exit(i32 16419, i32 0), !dbg !21
  ret void, !dbg !21
}
...
entry:
  call void @__dp_func_entry(i32 16422, i32 1)
  %retval = alloca i32, align 4
  %0 = ptrtoint i32* %retval to i64
  call void @__dp_write(i32 16422, i64 %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i32 0, i32 0))
  store i32 0, i32* %retval, align 4
  call void @__dp_call(i32 16425), !dbg !25
  call void @foo(), !dbg !25
  call void @__dp_finalize(i32 16427), !dbg !26
  ret i32 0, !dbg !26
}
