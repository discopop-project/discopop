...
for.body3:                                        ; preds = %for.cond1
  ...
  %idxprom4 = sext i32 %7 to i64, !dbg !53
  %arrayidx5 = getelementptr inbounds [100 x i32], [100 x i32]* %a, i64 0, i64 %idxprom4, !dbg !53
  %8 = load i32, i32* %arrayidx5, align 4, !dbg !53
  %add = add nsw i32 %8, 1, !dbg !54
  %9 = load i32, i32* %i, align 4, !dbg !55
  %add6 = add nsw i32 %9, 1, !dbg !56
...
for.end11:                                        ; preds = %for.cond1
  ...
  %11 = load i32, i32* %arrayidx12, align 8, !dbg !63
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 %11), !dbg !64
  ret i32 0, !dbg !65
}
