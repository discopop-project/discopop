...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_read(i32 16413, i64 %4, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
  %5 = load i32, i32* @var, align 4, !dbg !22
  %inc = add nsw i32 %5, 1, !dbg !22
  %6 = ptrtoint i32* @var to i64
  call void @__dp_write(i32 16413, i64 %6, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
  store i32 %inc, i32* @var, align 4, !dbg !22
  %7 = ptrtoint i32* @var to i64
  call void @__dp_read(i32 16416, i64 %7, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
  %8 = load i32, i32* @var, align 4, !dbg !24
  %sub = sub nsw i32 %8, 2, !dbg !24
  %9 = ptrtoint i32* @var to i64
  call void @__dp_write(i32 16416, i64 %9, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
  store i32 %sub, i32* @var, align 4, !dbg !24
  br label %for.inc, !dbg !25

for.inc:                                          ; preds = %for.body
  %10 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16411, i64 %10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %11 = load i32, i32* %i, align 4, !dbg !26
  %inc1 = add nsw i32 %11, 1, !dbg !26
  %12 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16411, i64 %12, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
...
for.end:                                          ; preds = %for.cond
  ...
  call void @__dp_read(i32 16419, i64 %13, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
  %14 = load i32, i32* @var, align 4, !dbg !30
  call void @__dp_call(i32 16419), !dbg !31
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %14), !dbg !31
  call void @__dp_finalize(i32 16420), !dbg !32
  ret i32 0, !dbg !32
}
