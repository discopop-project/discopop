...
entry:
  ...
  call void @__dp_write(i32 16411, i64 %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  store i32 1, i32* %c, align 4, !dbg !19
  %2 = ptrtoint i32* %a to i64
  call void @__dp_write(i32 16413, i64 %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  store i32 2, i32* %a, align 4, !dbg !21
  %3 = ptrtoint i32* %b to i64
  call void @__dp_write(i32 16415, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  store i32 3, i32* %b, align 4, !dbg !22
  %4 = ptrtoint i32* %a to i64
  call void @__dp_read(i32 16417, i64 %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  %5 = load i32, i32* %a, align 4, !dbg !23
  %6 = ptrtoint i32* %c to i64
  call void @__dp_read(i32 16417, i64 %6, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %7 = load i32, i32* %c, align 4, !dbg !24
  %add = add nsw i32 %7, %5, !dbg !24
  %8 = ptrtoint i32* %c to i64
  call void @__dp_write(i32 16417, i64 %8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  store i32 %add, i32* %c, align 4, !dbg !24
  %9 = ptrtoint i32* %b to i64
  call void @__dp_read(i32 16419, i64 %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  %10 = load i32, i32* %b, align 4, !dbg !25
  %11 = ptrtoint i32* %c to i64
  call void @__dp_read(i32 16419, i64 %11, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %12 = load i32, i32* %c, align 4, !dbg !26
  %add1 = add nsw i32 %12, %10, !dbg !26
  %13 = ptrtoint i32* %c to i64
  call void @__dp_write(i32 16419, i64 %13, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  store i32 %add1, i32* %c, align 4, !dbg !26
  %14 = ptrtoint i32* %c to i64
  call void @__dp_read(i32 16421, i64 %14, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %15 = load i32, i32* %c, align 4, !dbg !27
  %16 = ptrtoint i32* %d to i64
  call void @__dp_write(i32 16421, i64 %16, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  store i32 %15, i32* %d, align 4, !dbg !28
  %17 = ptrtoint i32* %d to i64
  call void @__dp_read(i32 16424, i64 %17, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  %18 = load i32, i32* %d, align 4, !dbg !29
  call void @__dp_call(i32 16424), !dbg !30
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %18), !dbg !30
  call void @__dp_finalize(i32 16425), !dbg !31
  ret i32 0, !dbg !31
}
