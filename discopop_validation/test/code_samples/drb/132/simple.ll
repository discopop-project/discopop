...
entry:
  ...
  %1 = load i32, i32* %x, align 4, !dbg !15
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %1), !dbg !16
  ret i32 0, !dbg !17
}
...
!1 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/132")
!2 = !{}
...
!13 = !DILocation(line: 25, column: 6, scope: !14)
