...
entry:
  ...
  call void @__dp_write(i32 16442, i64 %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  call void @__dp_read(i32 16442, i64 %5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  %6 = load i32, i32* %i, align 4, !dbg !30
  %7 = ptrtoint i32* %len to i64
  call void @__dp_read(i32 16442, i64 %7, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_read(i32 16443, i64 %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16443, i64 %13, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  store i32 %10, i32* %arrayidx, align 4, !dbg !38
  br label %for.inc, !dbg !37

for.inc:                                          ; preds = %for.body
  %14 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16442, i64 %14, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  %15 = load i32, i32* %i, align 4, !dbg !39
  %inc = add nsw i32 %15, 1, !dbg !39
  %16 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16442, i64 %16, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
...
for.end:                                          ; preds = %for.cond
  ...
  call void @__dp_write(i32 16447, i64 %17, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
...
for.cond1:                                        ; preds = %for.inc9, %for.end
  ...
  call void @__dp_read(i32 16447, i64 %18, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
...
for.body3:                                        ; preds = %for.cond1
  ...
  call void @__dp_read(i32 16448, i64 %22, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  %23 = load i32, i32* %i, align 4, !dbg !52
  %add = add nsw i32 %23, 1, !dbg !53
  ...
  call void @__dp_read(i32 16448, i64 %24, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  %25 = load i32, i32* %arrayidx5, align 4, !dbg !54
  %add6 = add nsw i32 %25, 1, !dbg !55
  %26 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16448, i64 %26, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  %27 = load i32, i32* %i, align 4, !dbg !56
  %idxprom7 = sext i32 %27 to i64, !dbg !57
  %arrayidx8 = getelementptr inbounds [1000 x i32], [1000 x i32]* %a, i64 0, i64 %idxprom7, !dbg !57
  %28 = ptrtoint i32* %arrayidx8 to i64
  call void @__dp_write(i32 16448, i64 %28, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  store i32 %add6, i32* %arrayidx8, align 4, !dbg !58
  br label %for.inc9, !dbg !57

for.inc9:                                         ; preds = %for.body3
  %29 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16447, i64 %29, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  %30 = load i32, i32* %i, align 4, !dbg !59
  %inc10 = add nsw i32 %30, 1, !dbg !59
  %31 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16447, i64 %31, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
...
for.end11:                                        ; preds = %for.cond1
  ...
  call void @__dp_finalize(i32 16450), !dbg !63
  ret i32 0, !dbg !63
}
...
!1 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/026")
!2 = !{}
...
!63 = !DILocation(line: 66, column: 3, scope: !7)
