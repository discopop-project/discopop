...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  call void @__dp_read(i32 16445, i64 %6, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %7 = load i32, i32* %j, align 4, !dbg !37
  %8 = ptrtoint i32* @m to i64
  call void @__dp_read(i32 16445, i64 %8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  %9 = load i32, i32* @m, align 4, !dbg !39
  %cmp2 = icmp slt i32 %7, %9, !dbg !40
  br i1 %cmp2, label %for.body3, label %for.end, !dbg !41

for.body3:                                        ; preds = %for.cond1
  %10 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16446, i64 %10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %11 = load i32, i32* %i, align 4, !dbg !42
  %idxprom = sext i32 %11 to i64, !dbg !43
  %arrayidx = getelementptr inbounds [100 x [100 x double]], [100 x [100 x double]]* @b, i64 0, i64 %idxprom, !dbg !43
  %12 = ptrtoint i32* %j to i64
  call void @__dp_read(i32 16446, i64 %12, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %13 = load i32, i32* %j, align 4, !dbg !44
  %sub = sub nsw i32 %13, 1, !dbg !45
  ...
  call void @__dp_read(i32 16446, i64 %14, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  %15 = load double, double* %arrayidx5, align 8, !dbg !43
  %16 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16446, i64 %16, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %17 = load i32, i32* %i, align 4, !dbg !46
  %idxprom6 = sext i32 %17 to i64, !dbg !47
  ...
  call void @__dp_read(i32 16446, i64 %18, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %19 = load i32, i32* %j, align 4, !dbg !48
  %idxprom8 = sext i32 %19 to i64, !dbg !47
  ...
  call void @__dp_write(i32 16446, i64 %20, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  store double %15, double* %arrayidx9, align 8, !dbg !49
  br label %for.inc, !dbg !47

for.inc:                                          ; preds = %for.body3
  %21 = ptrtoint i32* %j to i64
  call void @__dp_read(i32 16445, i64 %21, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %22 = load i32, i32* %j, align 4, !dbg !50
  %inc = add nsw i32 %22, 1, !dbg !50
  %23 = ptrtoint i32* %j to i64
  call void @__dp_write(i32 16445, i64 %23, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
...
for.inc10:                                        ; preds = %for.end
  ...
  call void @__dp_read(i32 16444, i64 %24, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %25 = load i32, i32* %i, align 4, !dbg !54
  %inc11 = add nsw i32 %25, 1, !dbg !54
  %26 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16444, i64 %26, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  store i32 %inc11, i32* %i, align 4, !dbg !54
  br label %for.cond, !dbg !55, !llvm.loop !56

for.end12:                                        ; preds = %for.cond
  call void @__dp_loop_exit(i32 16447, i32 0)
  call void @__dp_func_exit(i32 16447, i32 0), !dbg !58
  ret void, !dbg !58
}
...
entry:
  ...
  call void @__dp_write(i32 16449, i64 %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i32 0, i32 0))
  store i32 0, i32* %retval, align 4
  call void @__dp_call(i32 16451), !dbg !62
  call void @foo(), !dbg !62
  call void @__dp_finalize(i32 16452), !dbg !63
  ret i32 0, !dbg !63
}
