...
for.end:                                          ; preds = %for.cond
  ...
  call void @__dp_read(i32 16411, i64 %10, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
  %11 = load i32, i32* @var, align 4, !dbg !29
  call void @__dp_call(i32 16411), !dbg !30
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %11), !dbg !30
  call void @__dp_finalize(i32 16412), !dbg !31
  ret i32 0, !dbg !31
}
...
!3 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/146")
!4 = !{}
!5 = !{!0}
...
!13 = !{!6}
!14 = !DILocalVariable(name: "i", scope: !15, file: !3, line: 23, type: !6)
!15 = distinct !DILexicalBlock(scope: !11, file: !3, line: 23, column: 3)
!16 = !DILocation(line: 23, column: 12, scope: !15)
!17 = !DILocation(line: 23, column: 8, scope: !15)
!18 = !DILocation(line: 23, column: 17, scope: !19)
!19 = distinct !DILexicalBlock(scope: !15, file: !3, line: 23, column: 3)
!20 = !DILocation(line: 23, column: 18, scope: !19)
!21 = !DILocation(line: 23, column: 3, scope: !15)
!22 = !DILocation(line: 25, column: 8, scope: !23)
!23 = distinct !DILexicalBlock(scope: !19, file: !3, line: 23, column: 26)
!24 = !DILocation(line: 26, column: 3, scope: !23)
!25 = !DILocation(line: 23, column: 23, scope: !19)
!26 = !DILocation(line: 23, column: 3, scope: !19)
!27 = distinct !{!27, !21, !28}
!28 = !DILocation(line: 26, column: 3, scope: !15)
!29 = !DILocation(line: 27, column: 18, scope: !11)
!30 = !DILocation(line: 27, column: 3, scope: !11)
