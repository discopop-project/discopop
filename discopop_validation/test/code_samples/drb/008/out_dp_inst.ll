...
entry:
  call void @__dp_func_entry(i32 16490, i32 1)
  ...
  call void @__dp_write(i32 16490, i64 %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0))
  store i32 0, i32* %retval, align 4
  %1 = ptrtoint i32* %argc.addr to i64
  call void @__dp_write(i32 16490, i64 %1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16490, i64 %2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0))
  ...
  call void @__dp_call(i32 16492), !dbg !29
  %call = call noalias i8* @malloc(i64 16208) #4, !dbg !29
  %3 = bitcast i8* %call to double*, !dbg !30
  %4 = ptrtoint double** %base to i64
  call void @__dp_write(i32 16492, i64 %4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0))
...
!3 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/008")
!4 = !{}
!5 = !{!6}
...
!17 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 106, type: !18, scopeLine: 107, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!18 = !DISubroutineType(types: !19)
!19 = !{!10, !10, !20}
!20 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !21, size: 64)
!21 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !22, size: 64)
!22 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!23 = !DILocalVariable(name: "argc", arg: 1, scope: !17, file: !3, line: 106, type: !10)
!24 = !DILocation(line: 106, column: 15, scope: !17)
!25 = !DILocalVariable(name: "argv", arg: 2, scope: !17, file: !3, line: 106, type: !20)
!26 = !DILocation(line: 106, column: 27, scope: !17)
!27 = !DILocalVariable(name: "base", scope: !17, file: !3, line: 108, type: !6)
!28 = !DILocation(line: 108, column: 12, scope: !17)
!29 = !DILocation(line: 108, column: 29, scope: !17)
!30 = !DILocation(line: 108, column: 19, scope: !17)
