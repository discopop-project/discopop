...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_read(i32 16407, i64 %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16407, i64 %6, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
  store i32 0, i32* %arrayidx, align 4, !dbg !27
  br label %for.inc, !dbg !28

for.inc:                                          ; preds = %for.body
  %7 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16406, i64 %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %8 = load i32, i32* %i, align 4, !dbg !29
  %inc = add nsw i32 %8, 1, !dbg !29
  %9 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16406, i64 %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
...
for.cond19:                                       ; preds = %for.inc27, %for.end17
  ...
  %cmp20 = icmp slt i32 %29, 64, !dbg !70
...
for.body21:                                       ; preds = %for.cond19
  ...
  %arrayidx23 = getelementptr inbounds [64 x i32], [64 x i32]* %var, i64 0, i64 %idxprom22, !dbg !75
  ...
  %cmp24 = icmp ne i32 %33, 100, !dbg !76
  br i1 %cmp24, label %if.then, label %if.end, !dbg !77

if.then:                                          ; preds = %for.body21
  %34 = ptrtoint i32* %i18 to i64
  call void @__dp_read(i32 16421, i64 %34, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %35 = load i32, i32* %i18, align 4, !dbg !78
  %idxprom25 = sext i32 %35 to i64, !dbg !80
  %arrayidx26 = getelementptr inbounds [64 x i32], [64 x i32]* %var, i64 0, i64 %idxprom25, !dbg !80
  %36 = ptrtoint i32* %arrayidx26 to i64
  call void @__dp_read(i32 16421, i64 %36, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
  %37 = load i32, i32* %arrayidx26, align 4, !dbg !80
  call void @__dp_call(i32 16421), !dbg !81
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %37), !dbg !81
...
for.inc27:                                        ; preds = %if.end
  ...
  %39 = load i32, i32* %i18, align 4, !dbg !84
  %inc28 = add nsw i32 %39, 1, !dbg !84
  ...
  store i32 %inc28, i32* %i18, align 4, !dbg !84
  br label %for.cond19, !dbg !85, !llvm.loop !86

for.end29:                                        ; preds = %for.cond19
  call void @__dp_loop_exit(i32 16425, i32 3)
  call void @__dp_finalize(i32 16425), !dbg !88
  ret i32 0, !dbg !88
}
...
!1 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/163")
!2 = !{}
...
!78 = !DILocation(line: 37, column: 25, scope: !79)
!79 = distinct !DILexicalBlock(scope: !73, file: !1, line: 36, column: 20)
!80 = !DILocation(line: 37, column: 21, scope: !79)
!81 = !DILocation(line: 37, column: 7, scope: !79)
!82 = !DILocation(line: 38, column: 5, scope: !79)
!83 = !DILocation(line: 39, column: 3, scope: !74)
!84 = !DILocation(line: 35, column: 22, scope: !69)
!85 = !DILocation(line: 35, column: 3, scope: !69)
!86 = distinct !{!86, !71, !87}
!87 = !DILocation(line: 39, column: 3, scope: !65)
!88 = !DILocation(line: 41, column: 3, scope: !7)
