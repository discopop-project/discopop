...
for.cond19:                                       ; preds = %for.inc27, %for.end17
  ...
  %cmp20 = icmp slt i32 %9, 64, !dbg !70
...
for.body21:                                       ; preds = %for.cond19
  ...
  %cmp24 = icmp ne i32 %11, 100, !dbg !76
  br i1 %cmp24, label %if.then, label %if.end, !dbg !77

if.then:                                          ; preds = %for.body21
  %12 = load i32, i32* %i18, align 4, !dbg !78
  %idxprom25 = sext i32 %12 to i64, !dbg !80
  %arrayidx26 = getelementptr inbounds [64 x i32], [64 x i32]* %var, i64 0, i64 %idxprom25, !dbg !80
  %13 = load i32, i32* %arrayidx26, align 4, !dbg !80
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %13), !dbg !81
