...
entry:
  ...
  call void @__dp_write(i32 16404, i64 %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  ...
  call void @__dp_read(i32 16406, i64 %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
...
if.then:                                          ; preds = %entry
  ...
  call void @__dp_read(i32 16407, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %4 = load i32, i32* %n.addr, align 4, !dbg !23
  %5 = ptrtoint i32* %retval to i64
  call void @__dp_write(i32 16407, i64 %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0))
  store i32 %4, i32* %retval, align 4, !dbg !24
  br label %return, !dbg !24

if.end:                                           ; preds = %entry
  %6 = ptrtoint i32* %n.addr to i64
  call void @__dp_read(i32 16409, i64 %6, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %7 = load i32, i32* %n.addr, align 4, !dbg !25
  %sub = sub nsw i32 %7, 1, !dbg !26
  call void @__dp_call(i32 16409), !dbg !27
  %call = call i32 @fib(i32 %sub), !dbg !27
  %8 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16409, i64 %8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  store i32 %call, i32* %i, align 4, !dbg !28
  %9 = ptrtoint i32* %n.addr to i64
  call void @__dp_read(i32 16411, i64 %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %10 = load i32, i32* %n.addr, align 4, !dbg !29
  %sub1 = sub nsw i32 %10, 2, !dbg !30
  call void @__dp_call(i32 16411), !dbg !31
  %call2 = call i32 @fib(i32 %sub1), !dbg !31
  %11 = ptrtoint i32* %j to i64
  call void @__dp_write(i32 16411, i64 %11, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  store i32 %call2, i32* %j, align 4, !dbg !32
  %12 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16413, i64 %12, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  %13 = load i32, i32* %i, align 4, !dbg !33
  %14 = ptrtoint i32* %j to i64
  call void @__dp_read(i32 16413, i64 %14, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  %15 = load i32, i32* %j, align 4, !dbg !34
  %add = add nsw i32 %13, %15, !dbg !35
  %16 = ptrtoint i32* %s to i64
  call void @__dp_write(i32 16413, i64 %16, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  store i32 %add, i32* %s, align 4, !dbg !36
  %17 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16415, i64 %17, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  %18 = load i32, i32* %i, align 4, !dbg !37
  %19 = ptrtoint i32* %j to i64
  call void @__dp_read(i32 16415, i64 %19, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  %20 = load i32, i32* %j, align 4, !dbg !38
  %add3 = add nsw i32 %18, %20, !dbg !39
  %21 = ptrtoint i32* %retval to i64
  call void @__dp_write(i32 16415, i64 %21, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0))
  store i32 %add3, i32* %retval, align 4, !dbg !40
  br label %return, !dbg !40

return:                                           ; preds = %if.end, %if.then
  %22 = ptrtoint i32* %retval to i64
  call void @__dp_read(i32 16416, i64 %22, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0))
  %23 = load i32, i32* %retval, align 4, !dbg !41
  call void @__dp_func_exit(i32 16416, i32 0), !dbg !41
  ret i32 %23, !dbg !41
}
...
entry:
  call void @__dp_func_entry(i32 16418, i32 1)
  %retval = alloca i32, align 4
  %argc.addr = alloca i32, align 4
  %argv.addr = alloca i8**, align 8
  %n = alloca i32, align 4
  %0 = ptrtoint i32* %retval to i64
  call void @__dp_write(i32 16418, i64 %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0))
  store i32 0, i32* %retval, align 4
  %1 = ptrtoint i32* %argc.addr to i64
  call void @__dp_write(i32 16418, i64 %1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16418, i64 %2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.7, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16419, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  store i32 10, i32* %n, align 4, !dbg !53
  %4 = ptrtoint i32* %argc.addr to i64
  call void @__dp_read(i32 16420, i64 %4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i32 0, i32 0))
...
if.then:                                          ; preds = %entry
  ...
  call void @__dp_read(i32 16421, i64 %6, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.7, i32 0, i32 0))
  %7 = load i8**, i8*** %argv.addr, align 8, !dbg !58
  %arrayidx = getelementptr inbounds i8*, i8** %7, i64 1, !dbg !58
  %8 = ptrtoint i8** %arrayidx to i64
  call void @__dp_read(i32 16421, i64 %8, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.7, i32 0, i32 0))
  %9 = load i8*, i8** %arrayidx, align 8, !dbg !58
  call void @__dp_call(i32 16421), !dbg !59
  %call = call i32 @atoi(i8* %9) #4, !dbg !59
  %10 = ptrtoint i32* %n to i64
  call void @__dp_write(i32 16421, i64 %10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  store i32 %call, i32* %n, align 4, !dbg !60
  br label %if.end, !dbg !61

if.end:                                           ; preds = %if.then, %entry
  %11 = ptrtoint i32* %n to i64
  call void @__dp_read(i32 16423, i64 %11, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %12 = load i32, i32* %n, align 4, !dbg !62
  %13 = ptrtoint i32* %n to i64
  call void @__dp_read(i32 16423, i64 %13, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %14 = load i32, i32* %n, align 4, !dbg !64
  call void @__dp_call(i32 16423), !dbg !65
  %call1 = call i32 @fib(i32 %14), !dbg !65
  call void @__dp_call(i32 16423), !dbg !66
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i32 %12, i32 %call1), !dbg !66
  call void @__dp_finalize(i32 16424), !dbg !67
  ret i32 0, !dbg !67
}
