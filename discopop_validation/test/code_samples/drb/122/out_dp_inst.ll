...
for.end:                                          ; preds = %for.cond
  ...
  call void @__dp_call(i32 16419), !dbg !39
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %14), !dbg !39
  call void @__dp_finalize(i32 16420), !dbg !40
  ret i32 0, !dbg !40
}
...
!1 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/122")
!2 = !{}
...
!39 = !DILocation(line: 35, column: 3, scope: !7)
!40 = !DILocation(line: 36, column: 3, scope: !7)
