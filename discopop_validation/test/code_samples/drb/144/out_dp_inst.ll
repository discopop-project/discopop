...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %cmp = icmp slt i32 %3, 200, !dbg !20
  br i1 %cmp, label %for.body, label %for.end, !dbg !21

for.body:                                         ; preds = %for.cond
  %4 = ptrtoint i32* @var to i64
  call void @__dp_read(i32 16410, i64 %4, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
  %5 = load i32, i32* @var, align 4, !dbg !22
  %inc = add nsw i32 %5, 1, !dbg !22
  %6 = ptrtoint i32* @var to i64
  call void @__dp_write(i32 16410, i64 %6, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
...
for.end:                                          ; preds = %for.cond
  ...
  call void @__dp_read(i32 16413, i64 %10, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
  %11 = load i32, i32* @var, align 4, !dbg !29
  call void @__dp_call(i32 16413), !dbg !30
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %11), !dbg !30
  call void @__dp_finalize(i32 16415), !dbg !31
  ret i32 0, !dbg !31
}
