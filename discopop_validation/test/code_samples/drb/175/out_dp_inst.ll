...
entry:
  ...
  call void @__dp_read(i32 16412, i64 %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %2 = load i32, i32* %a, align 4, !dbg !13
  %inc = add nsw i32 %2, 1, !dbg !13
  %3 = ptrtoint i32* %a to i64
  call void @__dp_write(i32 16412, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  store i32 %inc, i32* %a, align 4, !dbg !13
  %4 = ptrtoint i32* %a to i64
  call void @__dp_read(i32 16414, i64 %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %5 = load i32, i32* %a, align 4, !dbg !15
  call void @__dp_call(i32 16414), !dbg !16
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %5), !dbg !16
  call void @__dp_func_exit(i32 16415, i32 0), !dbg !17
  ret void, !dbg !17
}
...
entry:
  call void @__dp_func_entry(i32 16417, i32 1)
  %retval = alloca i32, align 4
  %0 = ptrtoint i32* %retval to i64
  call void @__dp_write(i32 16417, i64 %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0))
  store i32 0, i32* %retval, align 4
  call void @__dp_call(i32 16418), !dbg !21
  call void @foo(), !dbg !21
  call void @__dp_finalize(i32 16420), !dbg !22
  ret i32 0, !dbg !22
}
