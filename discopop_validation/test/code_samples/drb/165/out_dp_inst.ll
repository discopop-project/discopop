...
entry:
  ...
  call void @__dp_read(i32 16416, i64 %8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %9 = load i32, i32* %x, align 4, !dbg !17
  call void @__dp_call(i32 16416), !dbg !18
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %9), !dbg !18
  %10 = ptrtoint i32* %y to i64
  call void @__dp_read(i32 16417, i64 %10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  %11 = load i32, i32* %y, align 4, !dbg !19
  call void @__dp_call(i32 16417), !dbg !20
...
!1 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/165")
!2 = !{}
...
!20 = !DILocation(line: 33, column: 3, scope: !7)
