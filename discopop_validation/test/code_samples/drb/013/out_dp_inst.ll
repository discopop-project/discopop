...
entry:
  ...
  call void @__dp_read(i32 16447, i64 %2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16447, i64 %6, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0))
  store i8* %5, i8** %saved_stack, align 8, !dbg !18
  %vla = alloca i32, i64 %4, align 16, !dbg !18
  %7 = ptrtoint i64* %__vla_expr0 to i64
  call void @__dp_write(i32 16447, i64 %7, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16447, i64 %8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  store i32 5, i32* %b, align 4, !dbg !28
  %9 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16449, i64 %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  call void @__dp_read(i32 16449, i64 %10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %11 = load i32, i32* %i, align 4, !dbg !32
  %12 = ptrtoint i32* %len to i64
  call void @__dp_read(i32 16449, i64 %12, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0))
...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_read(i32 16450, i64 %14, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %15 = load i32, i32* %i, align 4, !dbg !37
  %16 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16450, i64 %16, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16450, i64 %18, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
  store i32 %15, i32* %arrayidx, align 4, !dbg !40
  br label %for.inc, !dbg !39

for.inc:                                          ; preds = %for.body
  %19 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16449, i64 %19, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %20 = load i32, i32* %i, align 4, !dbg !41
  %inc = add nsw i32 %20, 1, !dbg !41
  %21 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16449, i64 %21, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
...
for.end:                                          ; preds = %for.cond
  ...
  call void @__dp_write(i32 16455, i64 %22, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
...
for.cond1:                                        ; preds = %for.inc8, %for.end
  ...
  call void @__dp_read(i32 16455, i64 %23, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %24 = load i32, i32* %i, align 4, !dbg !49
  %25 = ptrtoint i32* %len to i64
  call void @__dp_read(i32 16455, i64 %25, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0))
...
for.body3:                                        ; preds = %for.cond1
  ...
  call void @__dp_read(i32 16456, i64 %27, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  %28 = load i32, i32* %b, align 4, !dbg !54
  %29 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16456, i64 %29, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  ...
  call void @__dp_read(i32 16456, i64 %31, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
  %32 = load i32, i32* %arrayidx5, align 4, !dbg !56
  %mul = mul nsw i32 %32, 5, !dbg !57
  %add = add nsw i32 %28, %mul, !dbg !58
  %33 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16456, i64 %33, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16456, i64 %35, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
  store i32 %add, i32* %arrayidx7, align 4, !dbg !61
  br label %for.inc8, !dbg !60

for.inc8:                                         ; preds = %for.body3
  %36 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16455, i64 %36, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %37 = load i32, i32* %i, align 4, !dbg !62
  %inc9 = add nsw i32 %37, 1, !dbg !62
  %38 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16455, i64 %38, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
...
for.end10:                                        ; preds = %for.cond1
  ...
  call void @__dp_read(i32 16459, i64 %39, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
  %40 = load i32, i32* %arrayidx11, align 4, !dbg !66
  %add12 = add nsw i32 %40, 1, !dbg !67
  %41 = ptrtoint i32* %error to i64
  call void @__dp_write(i32 16459, i64 %41, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.8, i32 0, i32 0))
  store i32 %add12, i32* %error, align 4, !dbg !68
  %42 = ptrtoint i32* %error to i64
  call void @__dp_read(i32 16462, i64 %42, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.8, i32 0, i32 0))
  %43 = load i32, i32* %error, align 4, !dbg !69
  call void @__dp_call(i32 16462), !dbg !70
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i32 %43), !dbg !70
  %44 = ptrtoint i32* %retval to i64
  call void @__dp_write(i32 16463, i64 %44, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0))
  store i32 0, i32* %retval, align 4, !dbg !71
  %45 = ptrtoint i8** %saved_stack to i64
  call void @__dp_read(i32 16464, i64 %45, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0))
  %46 = load i8*, i8** %saved_stack, align 8, !dbg !72
  call void @__dp_call(i32 16464), !dbg !72
  call void @llvm.stackrestore(i8* %46), !dbg !72
  %47 = ptrtoint i32* %retval to i64
  call void @__dp_read(i32 16464, i64 %47, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0))
  %48 = load i32, i32* %retval, align 4, !dbg !72
  call void @__dp_finalize(i32 16464), !dbg !72
  ret i32 %48, !dbg !72
}
