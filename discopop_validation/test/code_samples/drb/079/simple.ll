...
entry:
  ...
  %2 = load i32, i32* %j, align 4, !dbg !25
  %3 = load i32, i32* %k, align 4, !dbg !26
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32 %2, i32 %3), !dbg !27
  %4 = load i32, i32* %j, align 4, !dbg !28
  %cmp = icmp eq i32 %4, 1, !dbg !28
  br i1 %cmp, label %land.lhs.true, label %if.else, !dbg !28

land.lhs.true:                                    ; preds = %entry
  %5 = load i32, i32* %k, align 4, !dbg !28
  %cmp2 = icmp eq i32 %5, 1, !dbg !28
