...
for.body3:                                        ; preds = %for.cond1
  ...
  %6 = load double, double* %arrayidx5, align 8, !dbg !50
  %7 = load i32, i32* %i, align 4, !dbg !53
  %idxprom6 = sext i32 %7 to i64, !dbg !54
...
for.end12:                                        ; preds = %for.cond
  %11 = load double, double* getelementptr inbounds ([1000 x [1000 x double]], [1000 x [1000 x double]]* @b, i64 0, i64 500, i64 500), align 16, !dbg !65
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), double %11), !dbg !66
  ret i32 0, !dbg !67
}
