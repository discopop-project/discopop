...
for.cond45:                                       ; preds = %for.inc53, %for.end43
  ...
  %cmp46 = icmp slt i32 %24, 8, !dbg !133
...
if.then:                                          ; preds = %for.body47
  %28 = load i32, i32* %val, align 4, !dbg !142
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0), i32 %28, i32 %30), !dbg !146
...
return:                                           ; preds = %for.end55, %if.then
  %32 = load i32, i32* %retval, align 4, !dbg !154
  ret i32 %32, !dbg !154
}
