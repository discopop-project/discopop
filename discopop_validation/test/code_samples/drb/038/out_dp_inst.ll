...
if.end:                                           ; preds = %if.then, %entry
  ...
  call void @__dp_read(i32 16444, i64 %17, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  %18 = load i32, i32* %n, align 4, !dbg !38
  %19 = zext i32 %18 to i64, !dbg !39
  %20 = ptrtoint i32* %m to i64
  call void @__dp_read(i32 16444, i64 %20, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_write(i32 16448, i64 %33, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0))
...
for.cond2:                                        ; preds = %for.inc, %for.body
  ...
  call void @__dp_read(i32 16448, i64 %34, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0))
  %35 = load i32, i32* %j, align 4, !dbg !63
  %36 = ptrtoint i32* %m to i64
  call void @__dp_read(i32 16448, i64 %36, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
...
for.body4:                                        ; preds = %for.cond2
  ...
  call void @__dp_read(i32 16449, i64 %38, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
  ...
  call void @__dp_read(i32 16449, i64 %41, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0))
  ...
  call void @__dp_read(i32 16449, i64 %43, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i32 0, i32 0))
  %44 = load double, double* %arrayidx7, align 8, !dbg !69
  %45 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16449, i64 %45, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
  ...
  call void @__dp_read(i32 16449, i64 %48, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16449, i64 %50, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i32 0, i32 0))
  store double %44, double* %arrayidx11, align 8, !dbg !75
  br label %for.inc, !dbg !73

for.inc:                                          ; preds = %for.body4
  %51 = ptrtoint i32* %j to i64
  call void @__dp_read(i32 16448, i64 %51, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0))
  %52 = load i32, i32* %j, align 4, !dbg !76
  %inc = add nsw i32 %52, 1, !dbg !76
  %53 = ptrtoint i32* %j to i64
  call void @__dp_write(i32 16448, i64 %53, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0))
...
for.inc12:                                        ; preds = %for.end
  ...
  call void @__dp_read(i32 16446, i64 %54, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
  %55 = load i32, i32* %i, align 4, !dbg !80
  %inc13 = add nsw i32 %55, 1, !dbg !80
  %56 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16446, i64 %56, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0))
...
for.end14:                                        ; preds = %for.cond
  ...
  call void @__dp_write(i32 16451, i64 %57, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0))
  store i32 0, i32* %retval, align 4, !dbg !84
  %58 = ptrtoint i8** %saved_stack to i64
  call void @__dp_read(i32 16452, i64 %58, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.6, i32 0, i32 0))
  %59 = load i8*, i8** %saved_stack, align 8, !dbg !85
  call void @__dp_call(i32 16452), !dbg !85
  call void @llvm.stackrestore(i8* %59), !dbg !85
  %60 = ptrtoint i32* %retval to i64
  call void @__dp_read(i32 16452, i64 %60, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0))
  %61 = load i32, i32* %retval, align 4, !dbg !85
  call void @__dp_finalize(i32 16452), !dbg !85
  ret i32 %61, !dbg !85
}
