...
entry:
  ...
  call void @__dp_read(i32 16412, i64 %5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %6 = load i32, i32* %x, align 4, !dbg !16
  %7 = ptrtoint i32* %y to i64
  call void @__dp_read(i32 16412, i64 %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  %8 = load i32, i32* %y, align 4, !dbg !17
  %sub = sub nsw i32 %8, %6, !dbg !17
  %9 = ptrtoint i32* %y to i64
  call void @__dp_write(i32 16412, i64 %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  store i32 %sub, i32* %y, align 4, !dbg !17
  %10 = ptrtoint i32* %x to i64
  call void @__dp_read(i32 16417, i64 %10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %11 = load i32, i32* %x, align 4, !dbg !18
  call void @__dp_call(i32 16417), !dbg !19
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %11), !dbg !19
  %12 = ptrtoint i32* %y to i64
  call void @__dp_read(i32 16418, i64 %12, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  %13 = load i32, i32* %y, align 4, !dbg !20
  call void @__dp_call(i32 16418), !dbg !21
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %13), !dbg !21
  call void @__dp_func_exit(i32 16422, i32 0), !dbg !22
  ret void, !dbg !22
}
...
entry:
  call void @__dp_func_entry(i32 16424, i32 1)
  %retval = alloca i32, align 4
  %0 = ptrtoint i32* %retval to i64
  call void @__dp_write(i32 16424, i64 %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i32 0, i32 0))
  store i32 0, i32* %retval, align 4
  call void @__dp_call(i32 16427), !dbg !26
  call void @foo(), !dbg !26
  call void @__dp_finalize(i32 16429), !dbg !27
  ret i32 0, !dbg !27
}
...
!1 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/134")
!2 = !{}
...
!17 = !DILocation(line: 28, column: 5, scope: !7)
!18 = !DILocation(line: 33, column: 19, scope: !7)
!19 = !DILocation(line: 33, column: 3, scope: !7)
!20 = !DILocation(line: 34, column: 19, scope: !7)
!21 = !DILocation(line: 34, column: 3, scope: !7)
!22 = !DILocation(line: 38, column: 1, scope: !7)
!23 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 40, type: !24, scopeLine: 40, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!24 = !DISubroutineType(types: !25)
!25 = !{!11}
!26 = !DILocation(line: 43, column: 3, scope: !23)
!27 = !DILocation(line: 45, column: 3, scope: !23)
