...
entry:
  ...
  %2 = load i32, i32* %y, align 4, !dbg !17
  %sub = sub nsw i32 %2, %1, !dbg !17
  store i32 %sub, i32* %y, align 4, !dbg !17
  %3 = load i32, i32* %x, align 4, !dbg !18
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %3), !dbg !19
  %4 = load i32, i32* %y, align 4, !dbg !20
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %4), !dbg !21
  ret void, !dbg !22
}
