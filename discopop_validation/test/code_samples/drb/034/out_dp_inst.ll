...
if.end:                                           ; preds = %if.then, %entry
  ...
  call void @__dp_call(i32 16443), !dbg !31
  %14 = call i8* @llvm.stacksave(), !dbg !31
  %15 = ptrtoint i8** %saved_stack to i64
  call void @__dp_write(i32 16443, i64 %15, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4, i32 0, i32 0))
  store i8* %14, i8** %saved_stack, align 8, !dbg !31
  %vla = alloca i32, i64 %13, align 16, !dbg !31
  %16 = ptrtoint i64* %__vla_expr0 to i64
  call void @__dp_write(i32 16443, i64 %16, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.5, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16445, i64 %17, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
...
for.cond:                                         ; preds = %for.inc, %if.end
  ...
  call void @__dp_read(i32 16445, i64 %18, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %19 = load i32, i32* %i, align 4, !dbg !43
  %20 = ptrtoint i32* %len to i64
  call void @__dp_read(i32 16445, i64 %20, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_read(i32 16446, i64 %22, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %23 = load i32, i32* %i, align 4, !dbg !48
  %24 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16446, i64 %24, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16446, i64 %26, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
  store i32 %23, i32* %arrayidx2, align 4, !dbg !51
  br label %for.inc, !dbg !50

for.inc:                                          ; preds = %for.body
  %27 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16445, i64 %27, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %28 = load i32, i32* %i, align 4, !dbg !52
  %inc = add nsw i32 %28, 1, !dbg !52
  %29 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16445, i64 %29, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
...
for.end:                                          ; preds = %for.cond
  ...
  call void @__dp_write(i32 16449, i64 %30, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
...
for.cond3:                                        ; preds = %for.inc11, %for.end
  ...
  call void @__dp_read(i32 16449, i64 %31, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %32 = load i32, i32* %i, align 4, !dbg !59
  %33 = ptrtoint i32* %len to i64
  call void @__dp_read(i32 16449, i64 %33, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0))
  %34 = load i32, i32* %len, align 4, !dbg !61
  %div = sdiv i32 %34, 2, !dbg !62
  %cmp4 = icmp slt i32 %32, %div, !dbg !63
  br i1 %cmp4, label %for.body5, label %for.end13, !dbg !64

for.body5:                                        ; preds = %for.cond3
  %35 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16450, i64 %35, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  ...
  call void @__dp_read(i32 16450, i64 %37, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
  %38 = load i32, i32* %arrayidx7, align 4, !dbg !66
  %add = add nsw i32 %38, 1, !dbg !67
  %39 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16450, i64 %39, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %40 = load i32, i32* %i, align 4, !dbg !68
  %mul = mul nsw i32 2, %40, !dbg !69
  ...
  call void @__dp_write(i32 16450, i64 %41, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
  store i32 %add, i32* %arrayidx10, align 4, !dbg !72
  br label %for.inc11, !dbg !71

for.inc11:                                        ; preds = %for.body5
  %42 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16449, i64 %42, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %43 = load i32, i32* %i, align 4, !dbg !73
  %inc12 = add nsw i32 %43, 1, !dbg !73
  %44 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16449, i64 %44, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
...
for.end13:                                        ; preds = %for.cond3
  ...
  call void @__dp_write(i32 16452, i64 %45, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0))
  store i32 0, i32* %retval, align 4, !dbg !77
  %46 = ptrtoint i8** %saved_stack to i64
  call void @__dp_read(i32 16453, i64 %46, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4, i32 0, i32 0))
  %47 = load i8*, i8** %saved_stack, align 8, !dbg !78
  call void @__dp_call(i32 16453), !dbg !78
  call void @llvm.stackrestore(i8* %47), !dbg !78
  %48 = ptrtoint i32* %retval to i64
  call void @__dp_read(i32 16453, i64 %48, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0))
  %49 = load i32, i32* %retval, align 4, !dbg !78
  call void @__dp_finalize(i32 16453), !dbg !78
  ret i32 %49, !dbg !78
}
