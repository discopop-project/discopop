...
entry:
  ...
  call void @__dp_write(i32 16435, i64 %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0))
  store i32 0, i32* %retval, align 4
  call void @llvm.dbg.declare(metadata i32* %x, metadata !11, metadata !DIExpression()), !dbg !12
  %1 = ptrtoint i32* %x to i64
  call void @__dp_write(i32 16437, i64 %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16439, i64 %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  call void @__dp_read(i32 16439, i64 %3, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_write(i32 16442, i64 %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  store i32 %inc, i32* %x, align 4, !dbg !21
  br label %for.inc, !dbg !24

for.inc:                                          ; preds = %for.body
  %8 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16439, i64 %8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  %9 = load i32, i32* %i, align 4, !dbg !25
  %inc1 = add nsw i32 %9, 1, !dbg !25
  %10 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16439, i64 %10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
...
for.end:                                          ; preds = %for.cond
  ...
  call void @__dp_read(i32 16445, i64 %11, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  %12 = load i32, i32* %x, align 4, !dbg !29
  %cmp2 = icmp eq i32 %12, 100, !dbg !29
...
if.else:                                          ; preds = %for.end
  call void @__dp_finalize(i32 16445), !dbg !29
...
if.end:                                           ; preds = %if.then
  ...
  call void @__dp_read(i32 16446, i64 %13, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  %14 = load i32, i32* %x, align 4, !dbg !33
  call void @__dp_call(i32 16446), !dbg !34
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %14), !dbg !34
  call void @__dp_finalize(i32 16447), !dbg !35
  ret i32 0, !dbg !35
}
