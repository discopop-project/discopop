...
entry:
  ...
  call void @__dp_read(i32 16421, i64 %12, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  %13 = load i32, i32* %y, align 4, !dbg !22
  call void @__dp_call(i32 16421), !dbg !23
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %13), !dbg !23
  call void @__dp_func_exit(i32 16422, i32 0), !dbg !24
  ret void, !dbg !24
}
...
entry:
  ...
  call void @__dp_call(i32 16427), !dbg !28
  call void @foo(), !dbg !28
  call void @__dp_finalize(i32 16429), !dbg !29
  ret i32 0, !dbg !29
}
