...
for.body6:                                        ; preds = %for.cond3
  ...
  %conv9 = sitofp i32 %12 to double, !dbg !77
  %add = fadd double 1.000000e+00, %conv9, !dbg !78
  %13 = load double*, double** %xa1, align 8, !dbg !79
  %14 = load i32, i32* %idx, align 4, !dbg !80
  %idxprom10 = sext i32 %14 to i64, !dbg !79
  %arrayidx11 = getelementptr inbounds double, double* %13, i64 %idxprom10, !dbg !79
  %15 = load double, double* %arrayidx11, align 8, !dbg !81
  %add12 = fadd double %15, %add, !dbg !81
  store double %add12, double* %arrayidx11, align 8, !dbg !81
  %16 = load i32, i32* %i, align 4, !dbg !82
  %conv13 = sitofp i32 %16 to double, !dbg !82
  %add14 = fadd double 3.000000e+00, %conv13, !dbg !83
  %17 = load double*, double** %xa2, align 8, !dbg !84
  %18 = load i32, i32* %idx, align 4, !dbg !85
  %idxprom15 = sext i32 %18 to i64, !dbg !84
  %arrayidx16 = getelementptr inbounds double, double* %17, i64 %idxprom15, !dbg !84
  %19 = load double, double* %arrayidx16, align 8, !dbg !86
  %add17 = fadd double %19, %add14, !dbg !86
...
for.inc18:                                        ; preds = %for.body6
  ...
  %inc19 = add nsw i32 %20, 1, !dbg !88
  store i32 %inc19, i32* %i, align 4, !dbg !88
  br label %for.cond3, !dbg !89, !llvm.loop !90

for.end20:                                        ; preds = %for.cond3
  %21 = load double*, double** %xa1, align 8, !dbg !92
  %arrayidx21 = getelementptr inbounds double, double* %21, i64 999, !dbg !92
  %22 = load double, double* %arrayidx21, align 8, !dbg !92
  %23 = load double*, double** %xa2, align 8, !dbg !93
  %arrayidx22 = getelementptr inbounds double, double* %23, i64 1285, !dbg !93
  %24 = load double, double* %arrayidx22, align 8, !dbg !93
  %call23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i64 0, i64 0), double %22, double %24), !dbg !94
  %25 = load double*, double** %base, align 8, !dbg !95
  %26 = bitcast double* %25 to i8*, !dbg !95
  call void @free(i8* %26) #4, !dbg !96
