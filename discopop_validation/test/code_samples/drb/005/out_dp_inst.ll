...
entry:
  call void @__dp_func_entry(i32 16487, i32 1)
  ...
  call void @__dp_write(i32 16487, i64 %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0))
  store i32 0, i32* %retval, align 4
  %1 = ptrtoint i32* %argc.addr to i64
  call void @__dp_write(i32 16487, i64 %1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0))
  ...
  call void @__dp_write(i32 16487, i64 %2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0))
  ...
  call void @__dp_read(i32 16492, i64 %5, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0))
...
if.then:                                          ; preds = %entry
  ...
  call void @__dp_write(i32 16495, i64 %7, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0))
...
for.cond3:                                        ; preds = %for.inc18, %for.end
  ...
  br i1 %cmp4, label %for.body6, label %for.end20, !dbg !71
...
for.body6:                                        ; preds = %for.cond3
  ...
  call void @__dp_read(i32 16512, i64 %35, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8, i32 0, i32 0))
  %36 = load i32, i32* %i, align 4, !dbg !77
  %conv9 = sitofp i32 %36 to double, !dbg !77
  %add = fadd double 1.000000e+00, %conv9, !dbg !78
  %37 = ptrtoint double** %xa1 to i64
  call void @__dp_read(i32 16512, i64 %37, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i32 0, i32 0))
  %38 = load double*, double** %xa1, align 8, !dbg !79
  %39 = ptrtoint i32* %idx to i64
  call void @__dp_read(i32 16512, i64 %39, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.10, i32 0, i32 0))
  %40 = load i32, i32* %idx, align 4, !dbg !80
  %idxprom10 = sext i32 %40 to i64, !dbg !79
  %arrayidx11 = getelementptr inbounds double, double* %38, i64 %idxprom10, !dbg !79
  %41 = ptrtoint double* %arrayidx11 to i64
  call void @__dp_read(i32 16512, i64 %41, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i32 0, i32 0))
  %42 = load double, double* %arrayidx11, align 8, !dbg !81
  %add12 = fadd double %42, %add, !dbg !81
  %43 = ptrtoint double* %arrayidx11 to i64
  call void @__dp_write(i32 16512, i64 %43, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i32 0, i32 0))
  store double %add12, double* %arrayidx11, align 8, !dbg !81
  %44 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16513, i64 %44, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8, i32 0, i32 0))
  %45 = load i32, i32* %i, align 4, !dbg !82
  %conv13 = sitofp i32 %45 to double, !dbg !82
  %add14 = fadd double 3.000000e+00, %conv13, !dbg !83
  %46 = ptrtoint double** %xa2 to i64
  call void @__dp_read(i32 16513, i64 %46, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.7, i32 0, i32 0))
  %47 = load double*, double** %xa2, align 8, !dbg !84
  %48 = ptrtoint i32* %idx to i64
  call void @__dp_read(i32 16513, i64 %48, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.10, i32 0, i32 0))
  %49 = load i32, i32* %idx, align 4, !dbg !85
  %idxprom15 = sext i32 %49 to i64, !dbg !84
  %arrayidx16 = getelementptr inbounds double, double* %47, i64 %idxprom15, !dbg !84
  %50 = ptrtoint double* %arrayidx16 to i64
  call void @__dp_read(i32 16513, i64 %50, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.7, i32 0, i32 0))
  %51 = load double, double* %arrayidx16, align 8, !dbg !86
  %add17 = fadd double %51, %add14, !dbg !86
  %52 = ptrtoint double* %arrayidx16 to i64
  call void @__dp_write(i32 16513, i64 %52, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.7, i32 0, i32 0))
  store double %add17, double* %arrayidx16, align 8, !dbg !86
  br label %for.inc18, !dbg !87

for.inc18:                                        ; preds = %for.body6
  %53 = ptrtoint i32* %i to i64
  call void @__dp_read(i32 16509, i64 %53, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8, i32 0, i32 0))
  %54 = load i32, i32* %i, align 4, !dbg !88
  %inc19 = add nsw i32 %54, 1, !dbg !88
  %55 = ptrtoint i32* %i to i64
  call void @__dp_write(i32 16509, i64 %55, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8, i32 0, i32 0))
  store i32 %inc19, i32* %i, align 4, !dbg !88
  br label %for.cond3, !dbg !89, !llvm.loop !90

for.end20:                                        ; preds = %for.cond3
  call void @__dp_loop_exit(i32 16516, i32 1)
  %56 = ptrtoint double** %xa1 to i64
  call void @__dp_read(i32 16516, i64 %56, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i32 0, i32 0))
  %57 = load double*, double** %xa1, align 8, !dbg !92
  %arrayidx21 = getelementptr inbounds double, double* %57, i64 999, !dbg !92
  %58 = ptrtoint double* %arrayidx21 to i64
  call void @__dp_read(i32 16516, i64 %58, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i32 0, i32 0))
  %59 = load double, double* %arrayidx21, align 8, !dbg !92
  %60 = ptrtoint double** %xa2 to i64
  call void @__dp_read(i32 16516, i64 %60, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.7, i32 0, i32 0))
  %61 = load double*, double** %xa2, align 8, !dbg !93
  %arrayidx22 = getelementptr inbounds double, double* %61, i64 1285, !dbg !93
  %62 = ptrtoint double* %arrayidx22 to i64
  call void @__dp_read(i32 16516, i64 %62, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.7, i32 0, i32 0))
  %63 = load double, double* %arrayidx22, align 8, !dbg !93
  call void @__dp_call(i32 16516), !dbg !94
  %call23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i64 0, i64 0), double %59, double %63), !dbg !94
  %64 = ptrtoint double** %base to i64
  call void @__dp_read(i32 16517, i64 %64, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0))
  %65 = load double*, double** %base, align 8, !dbg !95
  %66 = bitcast double* %65 to i8*, !dbg !95
  call void @__dp_call(i32 16517), !dbg !96
  call void @free(i8* %66) #4, !dbg !96
  %67 = ptrtoint i32* %retval to i64
  call void @__dp_write(i32 16518, i64 %67, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0))
  store i32 0, i32* %retval, align 4, !dbg !97
  br label %return, !dbg !97

return:                                           ; preds = %for.end20, %if.then
  %68 = ptrtoint i32* %retval to i64
  call void @__dp_read(i32 16519, i64 %68, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0))
  %69 = load i32, i32* %retval, align 4, !dbg !98
  call void @__dp_finalize(i32 16519), !dbg !98
  ret i32 %69, !dbg !98
}
...
!3 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/005")
!4 = !{}
!5 = !{!6}
...
!17 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 103, type: !18, scopeLine: 104, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!18 = !DISubroutineType(types: !19)
!19 = !{!10, !10, !20}
!20 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !21, size: 64)
!21 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !22, size: 64)
!22 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!23 = !DILocalVariable(name: "argc", arg: 1, scope: !17, file: !3, line: 103, type: !10)
!24 = !DILocation(line: 103, column: 15, scope: !17)
!25 = !DILocalVariable(name: "argv", arg: 2, scope: !17, file: !3, line: 103, type: !20)
!26 = !DILocation(line: 103, column: 27, scope: !17)
...
!77 = !DILocation(line: 128, column: 22, scope: !73)
!78 = !DILocation(line: 128, column: 20, scope: !73)
!79 = !DILocation(line: 128, column: 5, scope: !73)
!80 = !DILocation(line: 128, column: 9, scope: !73)
!81 = !DILocation(line: 128, column: 13, scope: !73)
!82 = !DILocation(line: 129, column: 22, scope: !73)
!83 = !DILocation(line: 129, column: 20, scope: !73)
!84 = !DILocation(line: 129, column: 5, scope: !73)
!85 = !DILocation(line: 129, column: 9, scope: !73)
!86 = !DILocation(line: 129, column: 13, scope: !73)
!87 = !DILocation(line: 130, column: 3, scope: !73)
!88 = !DILocation(line: 125, column: 20, scope: !69)
!89 = !DILocation(line: 125, column: 3, scope: !69)
!90 = distinct !{!90, !71, !91}
!91 = !DILocation(line: 130, column: 3, scope: !66)
!92 = !DILocation(line: 132, column: 39, scope: !17)
!93 = !DILocation(line: 132, column: 49, scope: !17)
!94 = !DILocation(line: 132, column: 3, scope: !17)
!95 = !DILocation(line: 133, column: 9, scope: !17)
!96 = !DILocation(line: 133, column: 3, scope: !17)
!97 = !DILocation(line: 134, column: 3, scope: !17)
!98 = !DILocation(line: 135, column: 1, scope: !17)
