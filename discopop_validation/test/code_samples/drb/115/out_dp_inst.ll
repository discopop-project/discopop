...
for.end16:                                        ; preds = %for.cond3
  ...
  %arrayidx17 = getelementptr inbounds [100 x i32], [100 x i32]* %a, i64 0, i64 50, !dbg !74
  %41 = ptrtoint i32* %arrayidx17 to i64
  call void @__dp_read(i32 16452, i64 %41, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  %42 = load i32, i32* %arrayidx17, align 8, !dbg !74
  call void @__dp_call(i32 16452), !dbg !75
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 %42), !dbg !75
  call void @__dp_finalize(i32 16453), !dbg !76
  ret i32 0, !dbg !76
}
...
!1 = !DIFile(filename: "simple.c", directory: "/home/lukas/git/discopop/discopop_validation/test/code_samples/drb/115")
!2 = !{}
...
!74 = !DILocation(line: 68, column: 23, scope: !7)
!75 = !DILocation(line: 68, column: 3, scope: !7)
