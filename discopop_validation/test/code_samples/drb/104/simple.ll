...
for.end10:                                        ; preds = %for.cond1
  ...
  %cmp13 = icmp eq i32 %16, 51, !dbg !69
...
if.end:                                           ; preds = %if.then
  %17 = load i32, i32* %error, align 4, !dbg !73
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0), i32 %17), !dbg !74
  store i32 0, i32* %retval, align 4, !dbg !75
  %18 = load i8*, i8** %saved_stack, align 8, !dbg !76
  call void @llvm.stackrestore(i8* %18), !dbg !76
  %19 = load i32, i32* %retval, align 4, !dbg !76
  ret i32 %19, !dbg !76
}
