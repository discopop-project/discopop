...
for.body:                                         ; preds = %for.cond
  ...
  call void @__dp_read(i32 16393, i64 %8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %9 = load i32, i32* %x, align 4, !dbg !32
  %10 = ptrtoint i32* %y to i64
  call void @__dp_write(i32 16393, i64 %10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
...
for.end:                                          ; preds = %for.cond
  ...
  %15 = load i32, i32* %x, align 4, !dbg !39
  %cmp1 = icmp sgt i32 %15, 3, !dbg !41
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @__dp_read(i32 16403, i64 %26, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0))
  %27 = load i32, i32* %retval, align 4, !dbg !54
  call void @__dp_finalize(i32 16403), !dbg !54
  ret i32 %27, !dbg !54
}
...
!40 = distinct !DILexicalBlock(scope: !7, file: !8, line: 12, column: 8)
!41 = !DILocation(line: 12, column: 10, scope: !40)
!42 = !DILocation(line: 12, column: 8, scope: !7)
!43 = !DILocation(line: 13, column: 13, scope: !44)
!44 = distinct !DILexicalBlock(scope: !40, file: !8, line: 12, column: 14)
!45 = !DILocation(line: 13, column: 17, scope: !44)
!46 = !DILocation(line: 13, column: 15, scope: !44)
!47 = !DILocation(line: 13, column: 11, scope: !44)
!48 = !DILocation(line: 14, column: 5, scope: !44)
!49 = !DILocation(line: 16, column: 13, scope: !50)
!50 = distinct !DILexicalBlock(scope: !40, file: !8, line: 15, column: 9)
!51 = !DILocation(line: 16, column: 17, scope: !50)
!52 = !DILocation(line: 16, column: 15, scope: !50)
!53 = !DILocation(line: 16, column: 11, scope: !50)
!54 = !DILocation(line: 19, column: 1, scope: !7)
