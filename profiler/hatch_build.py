...
def _get_clang_version(clang_path: str) -> int | None:
    ...
    Returns the major version number if successful, None otherwise.
    """
    try:
...
def _check_clang_version_requirement(alternatives: list[str]) -> bool:
    ...
    For versioned clang (clang-19, etc.), presence is enough.
    For unversioned clang, also verify it's a supported version (19-22).
    """
