...
This page is used to store potential approaches for the mentioned problem which have been followed in the past.
<b>This page should not be openly visible and thus be removed before the next release.</b>


## Manual approach - How to use DiscoPoP with projects which use CMake build system?
...
## DiscoPoP Profiler - Usage with projects that use the CMake build system
